  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Szacunkowo 10–54%',
        options: ['Poniżej 1%', 'Szacunkowo 10–54%', 'Ponad 90%', 'Dokładnie 50%'],
      },
      {
        text: 'Jaka jest różnica między squirtingiem a żeńską ejakulacją?',
        answer: 'Squirting to płyn z pęcherza, ejakulacja – z gruczołów Skenego',
        options: ['Są identyczne – to to samo zjawisko', 'Squirting to płyn z pęcherza, ejakulacja – z gruczołów Skenego', 'Żeńska ejakulacja to tylko mit naukowy', 'Squirting jest niemożliwy biologicznie'],
      },
      {
        text: 'Ile płynu może wydzielić się podczas squirtingu?',
        answer: 'Od kilku ml do ponad 150 ml',
        options: ['Zawsze dokładnie 1 ml', 'Od kilku ml do ponad 150 ml', 'Zawsze ponad litr', 'Mniej niż kropla – squirting to mit'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Redukcja stresu, lepszy sen i ulga w bólu',
        options: ['Brak udowodnionych korzyści zdrowotnych', 'Wyłącznie chwilowa poprawa humoru', 'Redukcja stresu, lepszy sen i ulga w bólu', 'Wyłącznie poprawa libido'],
      },
      {
        text: 'Jak masturbacja wpływa na zdolność do osiągania orgazmu z partnerem?',
        answer: 'Zwiększa szansę na orgazm z partnerem',
        options: ['Zmniejsza wrażliwość na dotyk partnera', 'Zwiększa szansę na orgazm z partnerem', 'Nie ma żadnego związku', 'Zmniejsza pożądanie do partnera'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Około 1–2 razy tygodniowo',
        options: ['Kilka razy dziennie', 'Raz w miesiącu', 'Około 1–2 razy tygodniowo', 'Raz na pół roku'],
      },
      {
        text: 'Co mówi badanie Hite Report (1976) o masturbacji kobiet?',
        answer: 'Że masturbuje się 82% kobiet i osiągają orgazm łatwiej same',
        options: ['Że masturbacja jest rzadka i nie prowadzi do orgazmu', 'Że masturbuje się 82% kobiet i osiągają orgazm łatwiej same', 'Że tylko kobiety bez partnera się masturbują', 'Że masturbacja wywołuje poczucie winy'],
      },
      ...
      },
      {
        ...
        answer: 'Urządzenie medyczne do "masażu histerycznego"',
        options: ['Zabawka dziecięca do masażu stóp', 'Urządzenie medyczne do "masażu histerycznego"', 'Narzędzie chirurgiczne do ginekologii', 'Urządzenie do terapii reumatyzmu'],
      },
      {
        text: 'Kiedy pojawił się pierwszy elektryczny wibrator dostępny w sprzedaży?',
        answer: 'Około 1902 roku',
        options: ['Około 1850 roku', 'Około 1902 roku', 'W 1950 roku', 'Dopiero w latach 70. XX w.'],
      },
      {
        text: 'Ile procent kobiet, które używają wibratorów, osiąga orgazm łatwiej niż bez?',
        answer: 'Ponad 90%',
        options: ['Około 10%', 'Około 40%', 'Około 70%', 'Ponad 90%'],
      },
      {
        text: 'Ile procent par używa zabawek erotycznych razem podczas seksu?',
        answer: 'Około 25–30%',
      ...
      },
      {
        ...
        answer: 'Wibrator klitoryczny (zewnętrzny)',
        options: ['Wibrator waginalny typu dildo', 'Wibrator klitoryczny (zewnętrzny)', 'Wand massager do całego ciała', 'Wibrujące majtki zdalne'],
      },
      {
      ...
      },
      {
        ...
        answer: '21–35 dni',
        options: ['Zawsze dokładnie 28 dni', '7–14 dni', '21–35 dni', '40–60 dni'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Około 35–40 lat',
        options: ['Około 5–10 lat', 'Około 15–20 lat', 'Około 35–40 lat', 'Całe dorosłe życie – ponad 70 lat'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Ciężka forma PMS z nasilonymi objawami psychicznymi',
        options: ['Łagodna, przejściowa forma PMS', 'Ciężka forma PMS z nasilonymi objawami psychicznymi', 'Brak miesiączki przez kilka miesięcy', 'Stan po ciąży zanikający samoistnie'],
      },
      {
        text: 'Co to jest dysmenorrhea (bolesne miesiączkowanie)?',
        answer: 'Silne bóle skurczowe macicy podczas miesiączki',
        options: ['Nieregularne, nieprzewidywalne miesiączki', 'Silne bóle skurczowe macicy podczas miesiączki', 'Całkowity brak miesiączki', 'Krwawienie między miesiączkami'],
      },
      {
        text: 'Jak masturbacja lub orgazm może pomóc podczas bolesnej miesiączki?',
        answer: 'Orgazm uwalnia endorfiny, które łagodzą ból',
        options: ['Nasila ból przez dodatkowe skurcze', 'Orgazm uwalnia endorfiny, które łagodzą ból', 'Nie ma żadnego wpływu', 'Skraca krwawienie o połowę'],
      },
      {
        text: 'Jak libido zmienia się przez cały cykl menstruacyjny?',
        answer: 'Rośnie przed owulacją, spada później',
        options: ['Jest zawsze stałe – hormony nie wpływają', 'Jest najwyższe podczas miesiączki', 'Rośnie przed owulacją, spada później', 'Najwyższe w fazie lutealnej (tydzień 3–4)'],
      },
      {
        text: 'Co to jest menstruacja wsteczna (retrograde menstruation)?',
        answer: 'Krew cofa się przez jajowody do jamy otrzewnowej',
        options: ['Miesiączka trwająca wstecznie – od końca cyklu', 'Krew cofa się przez jajowody do jamy otrzewnowej', 'Brak miesiączki mimo normalnych hormonów', 'Krwawienie z odbytu podczas miesiączki'],
      },
      {
        text: 'Ile procent kobiet doświadcza nieregularnych miesiączek?',
        answer: 'Około 14–25%',
        options: ['Poniżej 1%', 'Około 5%', 'Około 14–25%', 'Ponad 80%'],
      },
      {
        text: 'Co to jest amenorrhea i kiedy jest niepokojąca?',
        answer: 'Brak miesiączki dłużej niż 3 miesiące',
        options: ['Zbyt obfita, przedłużająca się miesiączka', 'Brak miesiączki dłużej niż 3 miesiące', 'Bolesna, skurczowa miesiączka', 'Skąpa miesiączka – mniej niż 5 ml'],
      },
      {
        text: 'Jak intensywny wysiłek fizyczny (np. maraton) wpływa na cykl?',
        answer: 'Może powodować zanik miesiączki przez spadek estrogenów',
        options: ['Reguluje cykl i zmniejsza PMS', 'Może powodować zanik miesiączki przez spadek estrogenów', 'Nie ma żadnego wpływu na hormony', 'Przyspiesza owulację o kilka dni'],
      },

      // ── LIBIDO I POŻĄDANIE ───────────────────────────────────────────────────
      {
        text: 'Który zmysł najbardziej wpływa na libido kobiet według badań?',
        answer: 'Węch – zapachy ciała i feromony',
        options: ['Wzrok – atrakcyjność fizyczna', 'Słuch – głos i słowa', 'Dotyk i bliskość fizyczna', 'Węch – zapachy ciała i feromony'],
      },
      {
        text: 'Co to jest "responsive desire" w odróżnieniu od "spontaneous desire"?',
        answer: 'Pożądanie pojawia się w reakcji na kontekst, nie samoistnie',
        options: ['To stan chorobowy wymagający leczenia', 'To typ pożądania wyłącznie kobiecy', 'Pożądanie pojawia się w reakcji na kontekst, nie samoistnie', 'Obydwa typy są identyczne i nie różnią się'],
      },
      {
        text: 'Jak stres wpływa na libido kobiety?',
        answer: 'Silnie je obniża przez działanie kortyzolu',
        options: ['Zwiększa libido przez adrenalinę', 'Nie ma żadnego wpływu', 'Silnie je obniża przez działanie kortyzolu', 'Wpływa tylko na libido mężczyzn'],
      },
      {
        text: 'W jakim przedziale wiekowym kobiety mają statystycznie najwyższe libido?',
        answer: 'Między 27 a 33 rokiem życia',
        options: ['Między 16 a 18 rokiem życia', 'Między 27 a 33 rokiem życia', 'Po menopauzie – brak stresu o ciążę', 'Libido jest stałe przez całe życie'],
      },
      {
        text: 'Jak regularna aktywność fizyczna wpływa na libido kobiety?',
        answer: 'Zwiększa je – lepsze ukrwienie i samoocena',
        options: ['Zmniejsza je – ciało jest zmęczone', 'Nie wpływa na libido', 'Zwiększa je – lepsze ukrwienie i samoocena', 'Tylko joga zwiększa libido, inne sporty nie'],
      },
      {
        text: 'Jak antydepresanty (SSRI) wpływają na libido kobiety?',
        answer: 'Często je obniżają i utrudniają orgazm',
        options: ['Zwiększają libido przez wyrównanie nastroju', 'Nie wpływają na libido', 'Często je obniżają i utrudniają orgazm', 'Wpływają tylko na mężczyzn'],
      },
      {
        text: 'Co to jest HSDD (Hypoactive Sexual Desire Disorder) u kobiet?',
        answer: 'Klinicznie niskie pożądanie powodujące cierpienie',
        options: ['Nadmierne, niekontrolowane pożądanie', 'Klinicznie niskie pożądanie powodujące cierpienie', 'Brak orgazmu mimo prawidłowego pożądania', 'Ból odczuwany podczas stosunku'],
      },
      {
        text: 'Jak hormonalna antykoncepcja wpływa na libido?',
        answer: 'U ok. 15–20% kobiet obniża libido',
        options: ['Zawsze zwiększa libido – brak stresu o ciążę', 'Nie wpływa na libido', 'U ok. 15–20% kobiet obniża libido', 'Całkowicie eliminuje pożądanie seksualne'],
      },
      {
        text: 'Jak zapach partnera wpływa na pożądanie seksualne kobiety?',
        answer: 'Pociągają je mężczyźni o odmiennym układzie odpornościowym',
        options: ['Zapach nie ma znaczenia – liczy się wygląd', 'Preferują zapach mężczyzn o identycznym DNA', 'Pociągają je mężczyźni o odmiennym układzie odpornościowym', 'Feromony ludzkie nie istnieją naukowo'],
      },
      {
        text: 'Jak alkohol wpływa na libido i doznania seksualne kobiety?',
        answer: 'Małe dawki rozluźniają, duże utrudniają orgazm',
        options: ['Zawsze zwiększa podniecenie seksualne', 'Nie wpływa na doznania seksualne', 'Małe dawki rozluźniają, duże utrudniają orgazm', 'Poprawia orgazm przez rozluźnienie mięśni'],
      },
      ...
      },
      {
        ...
        answer: 'Zaledwie około 1 000',
        options: ['Milion – tyle samo co przy urodzeniu', 'Kilkaset tysięcy', 'Zaledwie około 1 000', 'Zero – wszystkie zużyte do owulacji'],
      },
      {
        text: 'Ile komórek jajowych wyda kobieta przez całe życie w owulacjach?',
        answer: 'Około 400–500',
        options: ['Kilkanaście rocznie – tysiące łącznie', 'Około 400–500', 'Zaledwie 12 – jedna na rok', 'Dziesiątki tysięcy'],
      },
      {
        text: 'Jak długo żyje komórka jajowa po uwolnieniu podczas owulacji?',
        answer: '12–24 godziny',
        options: ['72 godziny', '12–24 godziny', '7 dni', 'Cały cykl – do następnej miesiączki'],
      },
      {
        text: 'Co to jest endometrium?',
        answer: 'Błona śluzowa wyściełająca wnętrze macicy',
        options: ['Zewnętrzna warstwa ściany macicy', 'Tkanka budująca ściany pochwy', 'Błona śluzowa wyściełająca wnętrze macicy', 'Tkanka wyściełająca jajowody'],
      },
      {
        text: 'Co to jest owulacja?',
        answer: 'Uwolnienie dojrzałej komórki jajowej z jajnika',
        options: ['Moment zapłodnienia komórki', 'Uwolnienie dojrzałej komórki jajowej z jajnika', 'Pierwsza miesiączka w życiu', 'Wydzielanie śluzu szyjkowego'],
      },
      {
        text: 'O ile wzrasta temperatura ciała kobiety po owulacji?',
        answer: 'O 0,2–0,5°C',
        options: ['Nie zmienia się w ogóle', 'O 0,2–0,5°C', 'O 2–3°C', 'Spada o 1°C'],
      },
      {
        text: 'Jak wygląda śluz szyjkowy w dniu owulacji?',
        answer: 'Przezroczysty, rozciągliwy jak białko jajka',
        options: ['Gęsty i biały jak mleko', 'Przezroczysty, rozciągliwy jak białko jajka', 'Brązowy i gęsty', 'Brak śluzu – dzień owulacji jest suchy'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Górna, najszersza część macicy',
        options: ['Dolna część macicy łącząca z pochwą', 'Szyjka macicy', 'Górna, najszersza część macicy', 'Jajowody wychodzące z macicy'],
      },

      // ── ZDROWIE INTYMNE KOBIET ───────────────────────────────────────────────
      {
        text: 'Jak często kobiety powinny chodzić na badania ginekologiczne?',
        answer: 'Przynajmniej raz w roku',
        options: ['Co 10 lat wystarczy', 'Co 5 lat', 'Przynajmniej raz w roku', 'Tylko gdy pojawią się objawy'],
      },
      {
        text: 'Co to jest endometrioza?',
        answer: 'Tkanka podobna do śluzówki macicy rośnie poza macicą',
        options: ['Złośliwy rak śluzówki macicy', 'Tkanka podobna do śluzówki macicy rośnie poza macicą', 'Bakteryjne zapalenie macicy', 'Przerost endometrium w macicy'],
      },
      {
        text: 'Ile procent kobiet cierpi na endometriozę?',
        answer: 'Około 10%',
        options: ['Poniżej 0,1%', 'Około 1%', 'Około 10%', 'Ponad 50%'],
      },
      {
        text: 'Co to jest PCOS (zespół policystycznych jajników)?',
        answer: 'Zaburzenie hormonalne z nieregularną owulacją i cystami',
        options: ['Złośliwy rak jajnika', 'Zaburzenie hormonalne z nieregularną owulacją i cystami', 'Bakteryjne zapalenie jajowodów', 'Łagodne guzy macicy'],
      },
      {
        text: 'Ile procent kobiet ma PCOS?',
        answer: 'Około 6–12%',
        options: ['Poniżej 0,5%', 'Około 2%', 'Około 6–12%', 'Ponad 40%'],
      },
      {
        text: 'Co to są mięśniaki macicy (fibroids)?',
        answer: 'Łagodne guzy mięśniówki macicy',
        options: ['Złośliwe nowotwory macicy', 'Łagodne guzy mięśniówki macicy', 'Zapalenie mięśnia macicy', 'Polipy endometrium'],
      },
      {
        text: 'Ile procent kobiet ma mięśniaki macicy do 50. roku życia?',
        answer: 'Około 70–80%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 30%', 'Około 70–80%'],
      },
      {
        text: 'Co to są ćwiczenia Kegela i jaką mają korzyść?',
        answer: 'Ćwiczenia mięśni dna miednicy',
        options: ['Ćwiczenia brzucha poprawiające postawę', 'Ćwiczenia mięśni dna miednicy', 'Rozciąganie mięśni jajowodów', 'Ćwiczenia relaksacyjne dla macicy'],
      },
      {
        text: 'Co to jest wypadanie narządów miednicy (pelvic organ prolapse)?',
        answer: 'Obniżenie macicy lub pęcherza do pochwy',
        options: ['Nowotwór narządów rodnych', 'Obniżenie macicy lub pęcherza do pochwy', 'Zapalenie mięśni miednicy', 'Brak miesiączki po porodzie'],
      },
      {
        text: 'Co to jest inkontynencja stresowa?',
        answer: 'Mimowolne oddawanie moczu przy kaszlu czy śmiechu',
        options: ['Stres powodujący zatrzymanie moczu', 'Mimowolne oddawanie moczu przy kaszlu czy śmiechu', 'Infekcja pęcherza wywołana stresem', 'Nocne moczenie u dorosłych kobiet'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Tkanka endometrium wrasta w ścianę mięśniową macicy',
        options: ['Brak endometrium – wcale nie rośnie', 'Tkanka endometrium wrasta w ścianę mięśniową macicy', 'Złośliwy nowotwór macicy', 'Bakteryjne zapalenie jajowodów'],
      },
      {
        text: 'Czym jest menstrual cup i jaką ma zaletę nad tamponem?',
        answer: 'Silikonowy kubeczek wielokrotnego użytku',
        options: ['Plastikowy tampon jednorazowy', 'Silikonowy kubeczek wielokrotnego użytku', 'Jednorazowa wkładka higieniczna', 'Urządzenie do zbierania śluzu szyjkowego'],
      },

      // ── HORMONY I CIĄŻA ──────────────────────────────────────────────────────
      {
        text: 'Jak estrogen wpływa na skórę kobiety?',
        answer: 'Utrzymuje jej grubość, elastyczność i nawilżenie',
        options: ['Powoduje trądzik i przetłuszczenie', 'Utrzymuje jej grubość, elastyczność i nawilżenie', 'Nie ma żadnego wpływu na skórę', 'Powoduje nadmierne owłosienie'],
      },
      {
        text: 'Ile tygodni trwa prawidłowa ciąża?',
        answer: '40 tygodni od ostatniej miesiączki',
        options: ['30 tygodni', '40 tygodni od ostatniej miesiączki', '52 tygodnie – rok', '20 tygodni – jak u małp'],
      },
      {
        text: 'Jak libido zmienia się w trakcie ciąży?',
        answer: 'Najczęściej rośnie w II trymestrze',
        options: ['Zawsze zanika całkowicie', 'Najczęściej rośnie w II trymestrze', 'Jest identyczne jak przed ciążą', 'Rośnie wyłącznie w III trymestrze'],
      },
      {
        text: 'Czy seks podczas ciąży jest bezpieczny?',
        answer: 'Tak – dla większości ciąż jest bezpieczny aż do porodu',
        options: ['Nie – może wywołać poronienie', 'Bezpieczny tylko w I trymestrze', 'Tak – dla większości ciąż jest bezpieczny aż do porodu', 'Tylko w pozycji misjonarza'],
      },
      {
        text: 'Co to jest hCG i dlaczego jest ważny dla kobiet?',
        answer: 'Hormon ciążowy wykrywany w testach ciążowych',
        options: ['Hormon regulujący miesiączkę', 'Hormon ciążowy wykrywany w testach ciążowych', 'Hormon wywołujący owulację', 'Hormon produkowany przez tarczycę'],
      },
      {
        text: 'Jak tarczyca wpływa na płodność kobiety?',
        answer: 'Zaburzenia tarczycy mogą zaburzać owulację',
        options: ['Tarczyca nie ma żadnego wpływu na płodność', 'Zaburzenia tarczycy mogą zaburzać owulację', 'Tarczyca wpływa tylko na płodność mężczyzn', 'Tarczyca reguluje wyłącznie libido'],
      },
      {
        text: 'Co to jest prolaktyna i jak wpływa na kobiety po porodzie?',
        answer: 'Hormon laktacji – pobudza produkcję mleka i hamuje owulację',
        options: ['Hormon wywołujący depresję poporodową', 'Hormon laktacji – pobudza produkcję mleka i hamuje owulację', 'Hormon regulujący skurcze macicy podczas porodu', 'Hormon odpowiedzialny za libido po porodzie'],
      },
      {
        text: 'Ile procent kobiet doświadcza depresji poporodowej?',
        answer: 'Około 10–15%',
        options: ['Poniżej 0,1%', 'Około 2%', 'Około 10–15%', 'Prawie wszystkie matki – ~99%'],
      },
      {
        text: 'Co to jest badanie AMH (anty-Mullerowski hormon) i do czego służy?',
        answer: 'Wskaźnik rezerwy jajnikowej',
        options: ['Badanie poziomu estrogenów podczas menopauzy', 'Wskaźnik rezerwy jajnikowej', 'Test wykrywający ciążę z krwi', 'Marker nowotworowy jajnika'],
      },
      ...
      // ── MENOPAUZA ────────────────────────────────────────────────────────────
      {
        ...
        answer: 'Około 51 lat',
        options: ['Około 35–38 lat', 'Około 51 lat', 'Około 65 lat', 'Około 70 lat'],
      },
      {
        text: 'Co to jest perimenopauza?',
        answer: 'Okres przejściowy przed menopauzą',
        options: ['Menopauza trwająca tylko jeden miesiąc', 'Okres przejściowy przed menopauzą', 'Menopauza u kobiet przed 40. rokiem życia', 'Okres po menopauzie – stabilny hormonalnie'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Suchość pochwy i często niższe libido, ale nie u wszystkich',
        options: ['Całkowity zanik aktywności seksualnej u wszystkich', 'Suchość pochwy i często niższe libido, ale nie u wszystkich', 'Brak jakichkolwiek zmian seksualnych', 'Zawsze wzrost libido po menopauzie'],
      },
      {
        text: 'Co to jest GSM (genitourinary syndrome of menopause)?',
        answer: 'Suchość pochwy, ból i infekcje pęcherza po menopauzie',
        options: ['Rak narządów rodnych po menopauzie', 'Suchość pochwy, ból i infekcje pęcherza po menopauzie', 'Wypadanie macicy u kobiet po 60. roku życia', 'Normalny stan hormonalny po menopauzie'],
      },
      {
        text: 'Co to jest hormonalna terapia zastępcza (HTZ/HRT)?',
        answer: 'Uzupełnianie estrogenów po menopauzie',
        options: ['Terapia biologiczna nowotworów', 'Uzupełnianie estrogenów po menopauzie', 'Terapia hormonalna zmieniająca płeć', 'Leki antykoncepcyjne po menopauzie'],
      },
      {
        text: 'Co to jest menopauza przedwczesna (POI)?',
        answer: 'Wygaśnięcie funkcji jajników przed 40. rokiem życia',
        options: ['Menopauza między 50 a 55 rokiem życia', 'Wygaśnięcie funkcji jajników przed 40. rokiem życia', 'Menopauza trwająca krócej niż rok', 'Menopauza połączona z ciążą (niemożliwa)'],
      },
      {
        text: 'Jak menopauza wpływa na kości kobiety?',
        answer: 'Spadek estrogenów przyspiesza utratę masy kostnej',
        options: ['Kości stają się mocniejsze dzięki braku miesiączek', 'Brak wpływu – hormony nie mają związku z kośćmi', 'Spadek estrogenów przyspiesza utratę masy kostnej', 'Osteoporoza dotyka wyłącznie mężczyzn'],
      },
      ...
      },
      {
        ...
        answer: 'Około 30–45%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 30–45%', 'Prawie wszystkie – ~90%'],
      },
      {
        text: 'Kobiety stanowią jaki procent czytelników powieści erotycznych?',
        answer: 'Około 80–85%',
        options: ['Około 10%', 'Około 40%', 'Około 80–85%', 'Równo 50%'],
      },
      {
        text: 'Ile procent kobiet ma fantazje o byciu dominującą (w roli dominatrix)?',
        answer: 'Około 30–40%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 30–40%', 'Prawie wszystkie – BDSM dotyczy każdej'],
      },
      {
        text: 'Ile procent kobiet ma fantazje o byciu podporządkowaną / uległą?',
        answer: 'Około 50–65%',
        options: ['Poniżej 1% – to zaburzenie wymagające terapii', 'Około 10%', 'Około 50–65%', 'Prawie 0% – takie fantazje są patologiczne'],
      },
      {
        text: 'Czy fantazja seksualna zawsze oznacza chęć jej realizacji?',
        answer: 'Nie – większość kobiet nie chce ich realizować',
        options: ['Tak – fantazja to zawsze ukryte pragnienie', 'Nie – większość kobiet nie chce ich realizować', 'Tak, ale tylko młode kobiety', 'Fantazje zawsze są realizowane'],
      },
      {
        text: 'Jak pornografia dla kobiet ("female-friendly porn") różni się od tradycyjnej?',
        answer: 'Stawia na kontekst emocjonalny i kobiecą przyjemność',
        options: ['Nie różni się niczym', 'Stawia na kontekst emocjonalny i kobiecą przyjemność', 'Jest wyłącznie w formie audio', 'Zawiera wyłącznie treści lesbijskie'],
      },
      ...
      },
      {
        ...
        answer: 'Uwagę, zaangażowanie i dobrą komunikację',
        options: ['Wyłącznie wygląd fizyczny', 'Rozmiar penisa partnera', 'Uwagę, zaangażowanie i dobrą komunikację', 'Sprawność fizyczną i siłę'],
      },
      {
        text: 'Ile procent kobiet inicjuje seks w swoich związkach?',
        answer: 'Około 30–40%',
        options: ['Poniżej 1% – kobiety nigdy nie inicjują', 'Około 30–40%', 'Ponad 70% – kobiety inicjują częściej', 'Równo 50% – inicjatywa jest symetryczna'],
      },
      {
        text: 'Co kobiety deklarują jako najważniejszy czynnik satysfakcji seksualnej?',
        answer: 'Bycie pożądaną i emocjonalne połączenie',
        options: ['Czas trwania stosunku', 'Rozmiar penisa partnera', 'Bycie pożądaną i emocjonalne połączenie', 'Częstotliwość seksu w tygodniu'],
      },
      {
        text: 'Jak samoocena ciała wpływa na seksualność kobiety?',
        answer: 'Negatywna samoocena ciała utrudnia osiąganie orgazmu',
        options: ['Brak jakiegokolwiek związku', 'Kobiety z gorszą samooceną mają lepszy seks', 'Negatywna samoocena ciała utrudnia osiąganie orgazmu', 'Samoocena wpływa wyłącznie na libido'],
      },
      {
        text: 'Ile procent kobiet po porodzie odczuwa ból podczas powrotu do seksu?',
        answer: 'Około 45–50%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 45–50%', 'Prawie wszystkie – ~99%'],
      },
      ...
      },
      {
        ...
        answer: 'Estrogeny wzmacniają odpowiedź immunologiczną',
        options: ['Kobiety jedzą więcej warzyw', 'Estrogeny wzmacniają odpowiedź immunologiczną', 'Kobiety mają lepszy układ nerwowy', 'To mit – mężczyźni mają silniejszą odporność'],
      },
      {
        text: 'Kobiety mają więcej receptorów smaku niż mężczyźni – ile więcej?',
        answer: 'O ok. 20% więcej kubków smakowych',
        options: ['Mniejszą liczbę receptorów smaku', 'Identyczną ilość – to mit', 'O ok. 20% więcej kubków smakowych', 'Dwukrotnie więcej kubków smakowych'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Spoidło wielkie (corpus callosum)',
        options: ['Ciało migdałowate', 'Spoidło wielkie (corpus callosum)', 'Móżdżek', 'Kora wzrokowa'],
      },
      {
        text: 'Ile procent kobiet jest leworęczna?',
        answer: 'Około 9–10%',
        options: ['Tylko 1%', 'Około 9–10%', 'Ponad 30%', 'Kobiety zawsze są praworęczne'],
      },
      {
        text: 'Dlaczego kobiety są bardziej podatne na choroby autoimmunologiczne?',
        answer: 'Silniejsza odporność częściej atakuje własne tkanki',
        options: ['Kobiety mają słabszy układ odpornościowy', 'Silniejsza odporność częściej atakuje własne tkanki', 'Kobiety są bardziej narażone na stres', 'Hormony żeńskie uszkadzają własne komórki'],
      },
      {
        text: 'Co to jest "pink tax"?',
        answer: 'Wyższe ceny produktów dla kobiet niż dla mężczyzn',
        options: ['Podatek od tamponów i podpasek', 'Wyższe ceny produktów dla kobiet niż dla mężczyzn', 'Różnica w zarobkach między płciami', 'Opłata za wizyty ginekologiczne'],
      },
      {
        text: 'Jak kobiety śpią w porównaniu do mężczyzn?',
        answer: 'Potrzebują ok. 20 minut dłuższego snu',
        options: ['Kobiety śpią krócej i potrzebują mniej snu', 'Brak różnicy między płciami', 'Potrzebują ok. 20 minut dłuższego snu', 'Kobiety śpią głębiej – mniej problemów'],
      },
      {
        text: 'Ile procent badań klinicznych historycznie wykluczało kobiety jako uczestniczki?',
        answer: 'Do lat 90. ok. 70%',
        options: ['Poniżej 5%', 'Około 20%', 'Do lat 90. ok. 70%', 'Kobiety zawsze były włączane do badań'],
      },
      ...
      },
      {
        ...
        answer: 'Przewlekły ból sromu bez wyraźnej przyczyny',
        options: ['Ostry ból podczas miesiączki', 'Zapalenie pochwy wywołane grzybicą', 'Przewlekły ból sromu bez wyraźnej przyczyny', 'Ból po porodzie ustępujący po tygodniu'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Mimowolny skurcz mięśni pochwy uniemożliwiający penetrację',
        options: ['Dobrowolna, świadoma kontrola pochwy', 'Mimowolny skurcz mięśni pochwy uniemożliwiający penetrację', 'Przewlekła suchość pochwy', 'Brak odczuwania podczas stosunku'],
      },
      {
        text: 'Ile procent kobiet po menopauzie cierpi na suchość pochwy?',
        answer: 'Około 50–60%',
        options: ['Poniżej 5%', 'Około 20%', 'Około 50–60%', 'Prawie wszystkie – ~99%'],
      },
      {
        text: 'Jakie jest ryzyko raka szyjki macicy u kobiet niezaszczepionych i nieprzebadanych cytologicznie?',
        answer: 'Znacząco wyższe niż u zaszczepionych',
        options: ['Identyczne jak u zaszczepionych', 'Tylko nieznacznie wyższe', 'Znacząco wyższe niż u zaszczepionych', 'Niższe – mają silniejszą naturalną odporność'],
      },
      {
        text: 'Co to jest rak jajnika i dlaczego jest groźny?',
        answer: '"Cichy zabójca" – rzadko daje wczesne objawy',
        options: ['Łatwy do wykrycia przez badanie cytologiczne', '"Cichy zabójca" – rzadko daje wczesne objawy', 'Najczęstszy nowotwór kobiecy', 'Całkowicie wyleczalny, wykrywany wcześnie u ~95%'],
      },
      {
        text: 'Ile procent kobiet po 40. roku życia robi regularną mammografię?',
        answer: 'Tylko ok. 50–60%',
        options: ['Prawie wszystkie – ~95%', 'Około 80%', 'Tylko ok. 50–60%', 'Poniżej 5%'],
      },
      {
        text: 'Co kobiety powinny wiedzieć o raku piersi?',
        answer: 'Zachoruje 1 na 8 kobiet',
        options: ['Rak piersi dotyka wyłącznie kobiety po menopauzie', 'Zachoruje 1 na 8 kobiet', 'Rak piersi jest rzadki – poniżej 0,1% kobiet', 'Mężczyźni chorują równie często'],
      },
      ...
      // ── KOBIETY I PŁODNOŚĆ ───────────────────────────────────────────────────
      {
        ...
        answer: 'Około 5–10%',
        options: ['Ponad 80% – wiek nie ma znaczenia', 'Około 50%', 'Około 5–10%', 'Zero – ciąża po 40. jest niemożliwa'],
      },
      {
        text: 'Co to jest "zamrażanie komórek jajowych" (social egg freezing)?',
        answer: 'Szybkie mrożenie komórek jajowych na przyszłość',
        options: ['Zamrażanie całego jajnika', 'Szybkie mrożenie komórek jajowych na przyszłość', 'Hormonalne zatrzymanie owulacji na kilka lat', 'Przechowywanie zarodków po IVF'],
      },
      {
        text: 'Do jakiego wieku zamrożone komórki jajowe zachowują dobrą jakość wg ekspertów?',
        answer: 'Do ok. 35–37 roku życia',
        options: ['Do 20. roku życia', 'Do ok. 35–37 roku życia', 'Wiek nie ma znaczenia – jakość jest stała', 'Po 50. roku życia komórki są najlepsze'],
      },
      {
        text: 'Co to jest test owulacji (LH test) i jak działa?',
        answer: 'Wykrywa skok LH przed owulacją',
        options: ['Test ciążowy z moczu', 'Wykrywa skok LH przed owulacją', 'Badanie krwi mierzące estrogeny', 'USG sprawdzające rozmiar pęcherzyka'],
      },
      {
        text: 'Jak spożywanie alkoholu wpływa na płodność kobiety?',
        answer: 'Nawet umiarkowane spożycie może obniżyć szansę',
        options: ['Alkohol nie wpływa na płodność', 'Nawet umiarkowane spożycie może obniżyć szansę', 'Alkohol zwiększa płodność przez relaksację', 'Tylko ciężki alkoholizm wpływa na płodność'],
      },
      {
        text: 'Ile procent poronień wynika z wad chromosomalnych zarodka?',
        answer: 'Około 50–60%',
        options: ['Mniej niż 1%', 'Około 20%', 'Około 50–60%', 'Prawie wszystkie – ~99%'],
      },
      {
        text: 'Co to jest hiperstymulacja jajników (OHSS)?',
        answer: 'Powikłanie po stymulacji hormonalnej przy IVF',
        options: ['Naturalne powiększenie jajników podczas owulacji', 'Powikłanie po stymulacji hormonalnej przy IVF', 'Choroba autoimmunologiczna jajników', 'Infekcja jajników po zabiegu'],
      },

      // ── KOBIETY I ANTYKONCEPCJA ──────────────────────────────────────────────
      {
        text: 'Ile procent kobiet stosuje pigułkę antykoncepcyjną na świecie?',
        answer: 'Około 9% globalnie',
        options: ['Prawie wszystkie – ~90%', 'Około 50%', 'Około 9% globalnie', 'Mniej niż 1%'],
      },
      {
        text: 'Co to jest antykoncepcja awaryjna (plan B / ellaOne) i jak działa?',
        answer: 'Tabletka po stosunku opóźniająca owulację',
        options: ['Tabletka aborcyjna powodująca poronienie', 'Tabletka po stosunku opóźniająca owulację', 'Specjalna prezerwatywa po stosunku', 'Zastrzyk podawany przez lekarza w ciągu doby'],
      },
      {
        text: 'Jak wkładka domaciczna (IUD miedziana) działa antykoncepcyjnie?',
        answer: 'Miedź działa toksycznie na plemniki',
        options: ['Zatrzymuje owulację jak pigułka', 'Miedź działa toksycznie na plemniki', 'Tworzy fizyczną barierę przy penetracji', 'Zmienia pH pochwy na bardzo kwaśne'],
      },
      {
        text: 'Ile lat działa hormonalna wkładka domaciczna (IUD Mirena)?',
        answer: 'Do 8 lat',
        options: ['6 miesięcy', '1 rok', 'Do 8 lat', '20 lat'],
      },
      {
        text: 'Co to jest implant antykoncepcyjny (Implanon/Nexplanon)?',
        answer: 'Pręcik pod skórą ramienia uwalniający hormon',
        options: ['Tabletka do połknięcia raz w miesiącu', 'Pręcik pod skórą ramienia uwalniający hormon', 'Plaster przyklejany do brzucha', 'Zastrzyk podawany co tydzień'],
      },
      {
        text: 'Jak metoda naturalnego planowania rodziny (NPR) różni się od antykoncepcji hormonalnej?',
        answer: 'Opiera się na obserwacji cyklu, bez hormonów',
        options: ['NPR jest skuteczniejsza niż pigułka', 'Opiera się na obserwacji cyklu, bez hormonów', 'NPR i pigułka mają identyczną skuteczność', 'NPR to wyłącznie metoda termiczna'],
      },
      {
        text: 'Jaka jest skuteczność prezerwatywy żeńskiej (wewnętrznej)?',
        answer: 'Około 79–95% przy typowym stosowaniu',
        options: ['100% – jest szczelna jak torebka plastikowa', 'Około 79–95% przy typowym stosowaniu', 'Poniżej 50% – jest praktycznie bezużyteczna', 'Identyczna jak prezerwatywa męska – 98%'],
      },

      // ── KOBIETY I ZWIĄZKI ────────────────────────────────────────────────────
      {
        text: 'Co kobiety cenią najwyżej w potencjalnym partnerze seksualnym wg badań ewolucyjnych?',
        answer: 'Zasoby, status i zdolność do ochrony rodziny',
        options: ['Wyłącznie wygląd i muskulaturę', 'Zasoby, status i zdolność do ochrony rodziny', 'Poczucie humoru ponad wszystko inne', 'Inteligencję mierzoną testem IQ'],
      },
      {
        text: 'Jak kobiety reagują na "efekt halo" w kontekście seksualnym?',
        answer: 'Atrakcyjnych uznaje się za bardziej kompetentnych',
        options: ['Kobiety nie podlegają efektowi halo', 'Atrakcyjnych uznaje się za bardziej kompetentnych', 'Atrakcyjni uchodzą za mniej godnych zaufania', 'Efekt halo dotyczy wyłącznie mężczyzn'],
      },
      {
        text: 'Ile procent kobiet byłoby zadowolona z rzadszego seksu w związku niż ma aktualnie?',
        answer: 'Około 30–40%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 30–40%', 'Prawie wszystkie – kobiety zawsze chcą mniej'],
      },
      {
        text: 'Co mówią badania o kobietach i zdradzie?',
        answer: 'Zdradzają równie często, ale częściej z powodów emocjonalnych',
        options: ['Kobiety niemal nigdy nie zdradzają', 'Zdradzają równie często, ale częściej z powodów emocjonalnych', 'Kobiety zdradzają 3x częściej niż mężczyźni', 'Kobiety zdradzają wyłącznie dla seksu'],
      },
      {
        text: 'Jak kobiety reagują na "seksualną nudę" w długotrwałym związku?',
        answer: 'Szukają emocjonalnej głębi, rzadziej nowego partnera',
        options: ['Natychmiast kończą związek', 'Szukają emocjonalnej głębi, rzadziej nowego partnera', 'Akceptują nudę bez żadnego działania', 'Zawsze szukają kochanka poza związkiem'],
      },
      {
        text: 'Ile procent kobiet przyznaje, że ich najlepszy seks był z byłym partnerem?',
        answer: 'Około 35–40%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 35–40%', 'Prawie wszystkie – ~90%'],
      },
      {
        text: 'Jak długo trwa "etap zakochania" (limerence) z neurobiologicznego punktu widzenia?',
        answer: '6–18 miesięcy',
        options: ['Zawsze trwa całe życie', 'Dokładnie 3 miesiące', '6–18 miesięcy', 'Tylko 2 tygodnie'],
      },
      ...
      // ── KOBIETY W HISTORII I KULTURZE ────────────────────────────────────────
      {
        ...
        answer: 'W 1918 roku',
        options: ['Dopiero w 1945 roku', 'W 1918 roku', 'W 2000 roku', 'Kobiety w Polsce zawsze miały prawo głosu'],
      },
      {
        text: 'Kto napisał "Drugi sex" – przełomową książkę o kobiecości?',
        answer: 'Simone de Beauvoir',
        options: ['Virginia Woolf', 'Simone de Beauvoir', 'Betty Friedan', 'Germaine Greer'],
      },
      {
        text: 'Co to było "Kinsey Scale" i jak dotyczyło kobiet?',
        answer: 'Skala (0–6) mierząca orientację seksualną',
        options: ['Skala mierząca atrakcyjność fizyczną', 'Skala (0–6) mierząca orientację seksualną', 'Test IQ stworzony dla kobiet', 'Skala bólu menstruacyjnego'],
      },
      {
      ...
      },
      {
        ...
        answer: 'W 1990 roku',
        options: ['W 1950 roku', 'W 1990 roku', 'Dopiero w 2010 roku', 'WHO nigdy tego nie zrobiła'],
      },
      {
        text: 'Co to był ruch "SlutWalk" i skąd pochodzi?',
        answer: 'Marsz z 2011 r. przeciwko obwinianiu ofiar',
        options: ['Festiwal muzyczny dla kobiet w latach 70.', 'Marsz z 2011 r. przeciwko obwinianiu ofiar', 'Protest kobiet za prawem do aborcji', 'Ruch feministyczny z lat 60. walczący o pracę'],
      },
      {
        text: 'W którym roku kobiety uzyskały prawo do własnego konta bankowego bez zgody męża w USA?',
        answer: 'Dopiero w 1974 roku',
        options: ['W 1920 roku – razem z prawem głosu', 'W 1950 roku', 'Dopiero w 1974 roku', 'W 2000 roku'],
      },

      // ── KOBIETY I PSYCHOLOGIA SEKSUALNA ─────────────────────────────────────
      {
        text: 'Jak kobiety przeżywają seks emocjonalnie inaczej niż mężczyźni?',
        answer: 'Silniej łączą seks z emocjami i relacją',
        options: ['Identycznie – nie ma różnic emocjonalnych', 'Kobiety przeżywają seks czysto fizycznie', 'Silniej łączą seks z emocjami i relacją', 'Kobiety są bardziej wizualne niż mężczyźni'],
      },
      {
        text: 'Co to jest "sexual script" (skrypt seksualny) i jak dotyczy kobiet?',
        answer: 'Kulturowe scenariusze zachowań seksualnych',
        options: ['Biologicznie zaprogramowane zachowania seksualne', 'Kulturowe scenariusze zachowań seksualnych', 'Skrypt terapii seksualnej dla par', 'Plan działania w związku'],
      },
      {
        text: 'Ile procent kobiet doświadczyło problemu z podnieceniem seksualnym (trudności z nawilżeniem)?',
        answer: 'Około 20–25%',
        options: ['Poniżej 1%', 'Około 5%', 'Około 20–25%', 'Prawie wszystkie kobiety po 40. roku życia'],
      },
      {
        text: 'Jak trauma seksualna wpływa na seksualność kobiety?',
        answer: 'Często prowadzi do PTSD, bólu i lęku przed intymnością',
        options: ['Trauma nie ma wpływu na seksualność', 'Często prowadzi do PTSD, bólu i lęku przed intymnością', 'Zwiększa wrażliwość jako mechanizm kompensacyjny', 'Powoduje wyłącznie lęk, bez objawów fizycznych'],
      },
      {
        text: 'Co to jest "spectatoring" i jak wpływa na orgazm kobiety?',
        answer: 'Obserwowanie siebie z zewnątrz zamiast bycia obecną',
        options: ['Świadome ćwiczenie uważności ciała podczas seksu', 'Obserwowanie siebie z zewnątrz zamiast bycia obecną', 'Fantazjowanie o innym partnerze', 'Technika medytacyjna poprawiająca orgazm'],
      },
      {
        text: 'Jak mindfulness (uważność) wpływa na seksualność kobiety?',
        answer: 'Poprawia podniecenie, nawilżenie i zdolność do orgazmu',
        options: ['Nie ma związku z seksualnością', 'Zmniejsza podniecenie przez nadmierne analizowanie', 'Poprawia podniecenie, nawilżenie i zdolność do orgazmu', 'Mindfulness dotyczy tylko stresu, nie seksu'],
      },
      {
        text: 'Ile procent kobiet po doświadczeniu nieudanego seksu unika aktywności seksualnej przez pewien czas?',
        answer: 'Około 25–35%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 25–35%', 'Prawie wszystkie – ~90%'],
      },

      // ── KOBIETY I CIAŁO – DODATKOWE ──────────────────────────────────────────
      {
        text: 'Jak wiele razy piersi mogą zmienić rozmiar przez całe życie kobiety?',
        answer: 'Wielokrotnie – przez cykl, ciążę, wagę i menopauzę',
        options: ['Nigdy – rozmiar jest stały po dojrzewaniu', 'Raz – wyłącznie podczas ciąży', 'Wielokrotnie – przez cykl, ciążę, wagę i menopauzę', 'Dwa razy – w dojrzewaniu i po menopauzie'],
      },
      {
        text: 'Ile procent kobiet ma asymetryczne piersi?',
        answer: 'Niemal wszystkie – do 88%',
        options: ['Poniżej 1%', 'Około 20%', 'Około 50%', 'Niemal wszystkie – do 88%'],
      },
      {
        text: 'Dlaczego brodawki sutkowe mogą być wrażliwe w różnych fazach cyklu?',
        answer: 'Hormony zmieniają wrażliwość – szczyt przed miesiączką',
        options: ['Wrażliwość brodawek jest stała', 'Hormony zmieniają wrażliwość – szczyt przed miesiączką', 'Brodawki są wrażliwe tylko podczas karmienia', 'Tylko kobiety z dużymi piersiami to odczuwają'],
      },
      {
        text: 'Ile procent kobiet doświadcza mastalgii (bólu piersi) cyklicznie?',
        answer: 'Około 70%',
        options: ['Poniżej 5%', 'Około 25%', 'Około 70%', 'Prawie wszystkie – ~99%'],
      },
      {
        text: 'Co to jest gardnereloza i jak się objawia?',
        answer: 'Zaburzenie flory pochwy z rybim zapachem',
        options: ['Grzybica – biała serowata wydzielina bez zapachu', 'Zaburzenie flory pochwy z rybim zapachem', 'Wirusowe STI powodujące pęcherze na sromie', 'Pasożytnicze zakażenie bez żadnych objawów'],
      },
      {
        text: 'Ile procent kobiet po 40. roku życia doświadcza perimenopauzy?',
        answer: 'Może zacząć się po 40., a po 45. u większości',
        options: ['Zaczyna się dopiero po 60. roku życia', 'U wszystkich kobiet już po 30. roku życia', 'Może zacząć się po 40., a po 45. u większości', 'Perimenopauza trwa zawsze 10 dni'],
      },
      {
        text: 'Jak ciąża zmienia mózg kobiety?',
        answer: 'Zmiany strukturalne ułatwiające więź z dzieckiem',
        options: ['Ciąża zmniejsza inteligencję o 20% trwale', 'Zmiany strukturalne ułatwiające więź z dzieckiem', 'Ciąża nie wpływa na mózg kobiety', 'Mózg wraca do normy dzień po porodzie'],
      },
      {
        text: 'Ile procent kobiet doświadcza "pregnancy brain" – problemów z pamięcią i koncentracją?',
        answer: 'Około 80% ciężarnych',
        options: ['Poniżej 5% – to wyłącznie mit', 'Około 20%', 'Około 80% ciężarnych', 'Tylko kobiety z depresją ciążową'],
      },
      {
        text: 'Jak karmienie piersią wpływa na seksualne libido kobiety?',
        answer: 'Hormony karmienia często obniżają libido',
        options: ['Zawsze zwiększa libido', 'Nie wpływa na libido', 'Hormony karmienia często obniżają libido', 'Wzmacnia więź i poprawia seks'],
      },

      // ── FINAŁOWA SERIA ────────────────────────────────────────────────────────
      {
        text: 'Co mówią badania o kobietach i seksie po 60. roku życia?',
        answer: 'Około 40–65% jest aktywnych i zadowolonych',
        options: ['Aktywność seksualna całkowicie zanika po menopauzie', 'Około 40–65% jest aktywnych i zadowolonych', 'Seks po 60. możliwy tylko z pomocą leków', 'Tylko kobiety z partnerem są aktywne po 60.'],
      },
      {
        text: 'Co to jest "sexual afterglow" i jak długo trwa u kobiet?',
        answer: 'Poczucie bliskości i satysfakcji po seksie',
        options: ['Ból mięśni po intensywnym seksie', 'Poczucie bliskości i satysfakcji po seksie', 'Zjawisko tylko u mężczyzn po orgazmie', 'Zaczerwienienie skóry trwające kilka minut'],
      },
      {
        text: 'Ile procent kobiet używa aplikacji do śledzenia cyklu menstruacyjnego?',
        answer: 'Ponad 30%',
        options: ['Poniżej 1%', 'Około 10%', 'Ponad 30%', 'Prawie wszystkie – ~90%'],
      },
      {
        text: 'Jak data owulacji może wpływać na głos kobiety?',
        answer: 'Tuż przed owulacją staje się lekko wyższy',
        options: ['Głos nie zmienia się przez cały cykl', 'Tuż przed owulacją staje się lekko wyższy', 'Głos jest najniższy podczas owulacji', 'Zmiany głosu są losowe, niezwiązane z cyklem'],
      },
      {
        text: 'Ile procent kobiet odczuwa zwiększone libido podczas miesiączki?',
        answer: 'Około 20–30%',
        options: ['Prawie żadna – to fizycznie niemożliwe', 'Wszystkie – miesiączka zawsze zwiększa libido', 'Około 20–30%', 'Dokładnie 50%'],
      },
      {
        text: 'Co to jest "breastgasm" (orgazm z brodawek sutkowych)?',
        answer: 'Orgazm osiągany wyłącznie przez stymulację brodawek',
        options: ['Mit niemający podstaw w neurobiologii', 'Orgazm osiągany wyłącznie przez stymulację brodawek', 'Orgazm możliwy tylko podczas karmienia piersią', 'Termin opisujący przyjemność z masażu piersi'],
      },
      {
        text: 'Jak kobiety w Polsce postrzegają swoją atrakcyjność seksualną?',
        answer: 'Ok. 60% ocenia się jako mniej atrakcyjne niż są',
        options: ['Większość ma bardzo wysoką samoocenę seksualną', 'Ok. 60% ocenia się jako mniej atrakcyjne niż są', 'Samoocena identyczna jak u mężczyzn', 'Kobiety nie potrafią ocenić swojej atrakcyjności'],
      },
      {
        text: 'Co to jest "orgasmic meditation" (OM)?',
        answer: 'Uważność skupiona na 15-minutowej stymulacji łechtaczki',
        options: ['Medytacja buddyjska poprawiająca koncentrację', 'Uważność skupiona na 15-minutowej stymulacji łechtaczki', 'Technika kontrolowania oddechu podczas orgazmu', 'Forma jogi tantrycznej dla par'],
      },
      {
        text: 'Ile procent kobiet zmieniło swoje preferencje seksualne po terapii?',
        answer: 'Nie zmienia orientacji, ale pomaga ~70–80%',
        options: ['100% – terapia zawsze zmienia preferencje', 'Nie zmienia orientacji, ale pomaga ~70–80%', 'Mniej niż 5% – terapia jest nieskuteczna', 'Terapia zmienia wyłącznie orientację'],
      },
      {
        text: 'Ile procent kobiet regularnie czyta treści erotyczne (literatura, fanfiction)?',
        answer: 'Około 25–35%',
        options: ['Poniżej 1%', 'Około 10%', 'Około 25–35%', 'Ponad 80%'],
      },
      {
        text: 'Jak taniec wpływa na pewność seksualną kobiety?',
        answer: 'Zwiększa pewność ciała, libido i satysfakcję',
        options: ['Taniec nie ma związku z seksualnością', 'Zwiększa pewność ciała, libido i satysfakcję', 'Zmniejsza libido przez wyczerpanie fizyczne', 'Wpływa tylko na pewność siebie na imprezach'],
      },
      {
        text: 'Jaki procent kobiet twierdzi, że doświadczyła seksu lepszego po 30. niż przed 30. rokiem życia?',
        answer: 'Ponad 60%',
        options: ['Poniżej 5% – seks jest lepszy tylko u młodszych', 'Około 20%', 'Ponad 60%', 'Wiek nie ma wpływu na jakość seksu'],
      },
      {
        text: 'Ile procent kobiet przyznaje, że seks stał się lepszy po urodzeniu dziecka (po przejściowym trudnym okresie)?',
        answer: 'Około 30–40%',
        options: ['Poniżej 1%', 'Prawie żadna – macierzyństwo niszczy seks', 'Około 30–40%', 'Ponad 90%'],
      },
      {
        text: 'Jak kobiety reagują biologicznie na widok niemowlęcia?',
        answer: 'Wzrost oksytocyny i aktywacja układu nagrody',
        options: ['Brak reakcji hormonalnej na widok niemowlęcia', 'Wzrost oksytocyny i aktywacja układu nagrody', 'Wyłącznie reakcja stresowa z powodu hałasu', 'Kobiety bezdzietne nie mają żadnej reakcji'],
      },
      {
        text: 'Co to jest "empathy gap" między płciami w kontekście seksualnym?',
        answer: 'Trudność mężczyzn w rozumieniu kobiecej seksualności',
        options: ['Różnica w poziomie empatii w kłótniach', 'Trudność mężczyzn w rozumieniu kobiecej seksualności', 'Różnica w reakcjach emocjonalnych na filmy', 'Mit naukowy bez żadnych podstaw'],
      },
      {
        text: 'Ile procent kobiet doświadcza seksualnych skutków ubocznych po leczeniu raka piersi?',
        answer: 'Około 70–80%',
        options: ['Poniżej 5%', 'Około 20%', 'Około 70–80%', 'Prawie żadna – leczenie nie wpływa na seks'],
      },
      {
        text: 'Co to jest "sexual empowerment" i jak wpływa na satysfakcję kobiet?',
        answer: 'Poczucie prawa do własnej przyjemności seksualnej',
        options: ['Termin polityczny bez związku z seksem', 'Poczucie prawa do własnej przyjemności seksualnej', 'Przesadna asertywność szkodliwa dla relacji', 'Zjawisko dotyczące tylko kobiet po menopauzie'],
      },
      {
        text: 'Ile procent kobiet globalnie nie ma dostępu do antykoncepcji, pomimo że tego pragnie?',
        answer: 'Około 218 milionów kobiet',
        options: ['Mniej niż 1 milion', 'Około 10 milionów', 'Około 218 milionów kobiet', 'Ponad 3 miliardy'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Tylko około 30–40%',
        options: ['Prawie wszystkie – ~90%', 'Około 70%', 'Tylko około 30–40%', 'Poniżej 5%'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Około 55–65%',
        options: ['Poniżej 5%', 'Około 20%', 'Około 55–65%', 'Prawie wszystkie – ~99%'],
      },
      {
        text: 'Co to jest "aftercare" w kontekście seksualnym i dlaczego jest ważny dla kobiet?',
        answer: 'Opieka emocjonalna i fizyczna po seksie (tulenie, rozmowa)',
        options: ['Pielęgnacja ciała po seksie (prysznic, krem)', 'Opieka emocjonalna i fizyczna po seksie (tulenie, rozmowa)', 'Termin dla rekonwalescencji po operacji', 'Ćwiczenia Kegela wykonywane po stosunku'],
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Portoryko',
        options: ['Kuba', 'Jamajka', 'Portoryko', 'Brazylia'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Manhattan ma wermut, Old Fashioned cukier i bitter',
        options: ['Manhattan jest na bazie ginu', 'Old Fashioned zawiera szampana', 'Manhattan ma wermut, Old Fashioned cukier i bitter', 'Są identyczne – różnią się tylko kieliszkiem'],
      },
      {
        text: 'Co to jest Bellini?',
        answer: 'Prosecco z puree z białej brzoskwini',
        options: ['Szampan z sokiem truskawkowym', 'Prosecco z puree z białej brzoskwini', 'Wino musujące z mango i grenadyną', 'Wermut z sokiem pomarańczowym'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Szampan z likierem z czarnej porzeczki',
        options: ['Prosecco z sokiem pomarańczowym', 'Szampan z sokiem malinowym', 'Szampan z likierem z czarnej porzeczki', 'Wino musujące z wodą różaną'],
      },
      {
        text: 'Z czego składa się klasyczna Caipirinha?',
        answer: 'Cachaça, limonka, cukier trzcinowy',
        options: ['Rum, limonka, cukier, mięta', 'Tequila, limonka, sól', 'Cachaça, limonka, cukier trzcinowy', 'Wódka, limonka, cukier, syrop'],
      },
      {
        text: 'Co to jest Hugo?',
        answer: 'Prosecco, syrop z czarnego bzu, woda gazowana, mięta',
        options: ['Gin z tonikiem i ogórkiem', 'Prosecco, syrop z czarnego bzu, woda gazowana, mięta', 'Wódka z sokiem jabłkowym i cynamonem', 'Szampan z lodem i grenadyną'],
      },
      {
        text: 'Jak się nazywa drink z wódki i napoju energetycznego?',
        answer: 'Vodka Energy',
        options: ['Power Shot', 'Energizer', 'Vodka Energy', 'Electric Lemonade'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Gin z minimalną ilością wytrawnego wermutu',
        options: ['Martini podane bez lodu', 'Gin z tonikiem bez cukru', 'Gin z minimalną ilością wytrawnego wermutu', 'Wermut podany bez mieszania'],
      },
      {
        text: 'Co to jest "Long Island Iced Tea"?',
        answer: 'Mieszanka wódki, ginu, rumu, tequili i triple sec – bez herbaty',
        options: ['Herbata z whisky i lodem', 'Drink z rumu i herbaty mrożonej', 'Mieszanka wódki, ginu, rumu, tequili i triple sec – bez herbaty', 'Napar herbaciany z alkoholem cytrusowym'],
      },
      {
        text: 'Jaka jest różnica między shakerem a mieszaczem (stirrer) przy koktajlach?',
        answer: 'Shaker napowietrza i schładza; stirrer zachowuje klarowność',
        options: ['Shaker służy tylko do drinków bezalkoholowych', 'Stirrer jest szybszy i daje więcej lodu', 'Shaker napowietrza i schładza; stirrer zachowuje klarowność', 'Nie ma różnicy – to kwestia stylu barmana'],
      },
      {
        text: 'Co to jest "Pornstar Martini"?',
        answer: 'Wódka waniliowa, likier i sok z marakui',
        options: ['Wódka z sokiem truskawkowym i grenadyną', 'Gin, sok grejpfrutowy, syrop różany', 'Wódka waniliowa, likier i sok z marakui', 'Szampan z musem mango i wódką'],
      },
      {
        text: 'Co to jest "Espresso Martini"?',
        answer: 'Wódka, likier kawowy i świeże espresso',
        options: ['Kawa z whisky irlandzką i bitą śmietaną', 'Wódka z kawą mrożoną i mlekiem', 'Wódka, likier kawowy i świeże espresso', 'Amaretto z espresso i syropem cukrowym'],
      },
      // Wino
      {
      ...
      },
      {
        ...
        answer: 'Całość wpływu środowiska na charakter wina',
        options: ['Technika fermentacji w beczkach dębowych', 'Rocznik wina oznaczający jakość', 'Całość wpływu środowiska na charakter wina', 'Specjalny certyfikat jakości win francuskich'],
      },
      {
        text: 'Które wino zawiera więcej resweratrolu: czerwone czy białe?',
        answer: 'Czerwone – resweratrol pochodzi ze skórek winogron',
        options: ['Białe – ma lepszy skład antyoksydantów', 'Oba zawierają identyczną ilość', 'Czerwone – resweratrol pochodzi ze skórek winogron', 'Różowe – jest pośrednie między nimi'],
      },
      {
        text: 'Co to jest "Prosecco DOC"?',
        answer: 'Włoskie wino musujące z regionu Veneto i Friuli',
        options: ['Najdroższe wino musujące świata', 'Hiszpańska cava z apelacji DOC', 'Włoskie wino musujące z regionu Veneto i Friuli', 'Mieszanka szampana i wody mineralnej'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Wytrawny – poniżej 12 g cukru/l',
        options: ['Ekstra słodki szampan', 'Rocznikowy szampan wysokiej jakości', 'Wytrawny – poniżej 12 g cukru/l', 'Produkowany wyłącznie z Chardonnay'],
      },
      {
        text: 'Który region Francji produkuje wina Bordeaux?',
        answer: 'Akwitania (Gironde)',
        options: ['Burgundia', 'Alzacja', 'Akwitania (Gironde)', 'Langwedocja'],
      },
      {
        text: 'Z jakiego szczepu winogron pochodzi Chianti?',
        answer: 'Sangiovese',
        options: ['Barbera', 'Nebbiolo', 'Sangiovese', 'Montepulciano'],
      },
      {
        text: 'Co to jest wino Rosé?',
        answer: 'Wino z krótkiego kontaktu soku z czerwonymi skórkami',
        options: ['Zawsze mieszanka czerwonego i białego wina', 'Wino z krótkiego kontaktu soku z czerwonymi skórkami', 'Wino z różowych odmian winogron', 'Słodkie wino deserowe ze słonecznych rejonów'],
      },
      {
        text: 'Ile butelek wina mieści standardowa beczka bordelaise (barrique)?',
        answer: 'Około 300 butelek',
        options: ['Około 50 butelek', 'Około 150 butelek', 'Około 300 butelek', 'Ponad 600 butelek'],
      },
      {
        text: 'Co to jest "decanting" wina?',
        answer: 'Przelewanie wina do karafki dla dotlenienia',
        options: ['Schładzanie wina w lodzie', 'Mieszanie różnych roczników wina', 'Przelewanie wina do karafki dla dotlenienia', 'Filtrowanie wina przez membranę'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Białe wino fermentowane ze skórkami, o pomarańczowej barwie',
        options: ['Wino z pomarańczy, nie z winogron', 'Białe wino z dodatkiem soku pomarańczowego', 'Białe wino fermentowane ze skórkami, o pomarańczowej barwie', 'Wino o smaku cytrusowym z Hiszpanii'],
      },
      {
        text: 'Jak długo może leżakować Château Pétrus w piwnicy?',
        answer: 'Nawet 50+ lat',
        options: ['Maksymalnie 5 lat', 'Około 10–15 lat', 'Nawet 50+ lat', 'Wszystkie wina tracą jakość po 20 latach'],
      },
      {
        text: 'Co to jest wino "naturalne" (natural wine)?',
        answer: 'Wino z ekologicznych winogron, bez dodatków i siarki',
        options: ['Wino bez etykiety "E-numerów"', 'Wino produkowane wyłącznie we Francji', 'Wino z ekologicznych winogron, bez dodatków i siarki', 'Wino nieprzeterminowane – spożywane świeże'],
      },
      // Piwo
      {
        text: 'Czym różni się ale od lagera?',
        answer: 'Ale fermentuje górnie, lager dolnie',
        options: ['Ale zawsze ma więcej alkoholu', 'Lager jest ciemniejszy i mocniejszy', 'Ale fermentuje górnie, lager dolnie', 'Ale jest z pszenicy, lager z żyta'],
      },
      {
        text: 'Co to jest IPA?',
        answer: 'India Pale Ale – mocno chmielone piwo',
        options: ['Irish Pale Ale – piwo z Dublina', 'India Pale Ale – mocno chmielone piwo', 'Italian Premium Ale – włoski styl', 'Imperial Pale Ale – piwo powyżej 10%'],
      },
      {
        text: 'Który kraj wypija najwięcej piwa per capita?',
        answer: 'Czechy',
        options: ['Niemcy', 'Irlandia', 'Czechy', 'Australia'],
      },
      {
        text: 'Co to jest Reinheitsgebot?',
        answer: 'Bawarskie prawo czystości piwa z 1516 r.',
        options: ['Austriacki podatek na alkohol z XVIII w.', 'Bawarskie prawo czystości piwa z 1516 r.', 'Certyfikat jakości UE dla piwa', 'Regulamin spożywania alkoholu w Niemczech'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Ciemne piwo o smaku palonego słodu (np. Guinness)',
        options: ['Pszeniczne piwo z Niemiec', 'Czeskie piwo lagerowe', 'Ciemne piwo o smaku palonego słodu (np. Guinness)', 'Słodkie piwo deserowe z Belgii'],
      },
      {
        text: 'Skąd pochodzi piwo Leffe?',
        answer: 'Belgia',
        options: ['Holandia', 'Niemcy', 'Belgia', 'Francja'],
      },
      {
        text: 'Co to jest "craft beer" (piwo rzemieślnicze)?',
        answer: 'Piwo z małych, niezależnych browarów',
        options: ['Piwo bez dodatku drożdży przemysłowych', 'Piwo wyłącznie z organicznych składników', 'Piwo z małych, niezależnych browarów', 'Piwo dojrzewające w beczkach whisky'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Piwo z zawartością alkoholu poniżej 0,05%',
        options: ['Piwo z soku owocowego bez fermentacji', 'Piwo z zawartością alkoholu poniżej 0,05%', 'Zwykłe piwo rozcieńczone wodą', 'Piwo z drożdżami niezawierającymi alkoholu'],
      },
      // Wódka
      {
        text: 'Z czego najczęściej produkuje się polską wódkę?',
        answer: 'Żyto lub pszenica, rzadziej ziemniaki',
        options: ['Wyłącznie z ziemniaków', 'Z buraków cukrowych', 'Żyto lub pszenica, rzadziej ziemniaki', 'Z kukurydzy i sorgo'],
      },
      {
        text: 'Który kraj był pierwszym producentem wódki historycznie?',
        answer: 'Polska lub Rosja',
        options: ['Szwecja', 'Finlandia', 'Polska lub Rosja', 'Ukraina'],
      },
      {
        text: 'Co to jest wódka Żubrówka?',
        answer: 'Polska wódka aromatyzowana trawą żubrową',
        options: ['Litewska wódka z żubrem na etykiecie', 'Polska wódka aromatyzowana trawą żubrową', 'Białoruska wódka z esencją dębową', 'Rosyjska wódka z kłączem tataraku'],
      },
      {
        text: 'Ile razy standardowo destyluje się wódkę premium?',
        answer: 'Minimum 3 razy, często 5–6 razy',
        options: ['Jeden raz – to wystarczy do czystości', 'Minimum 3 razy, często 5–6 razy', 'Dokładnie 10 razy', 'Im więcej, tym gorzej – jakość spada'],
      },
      {
        text: 'Czym jest filtrowanie wódki przez węgiel aktywny?',
        answer: 'Usuwaniem zanieczyszczeń i kongenerów dla łagodności',
        options: ['Dodawaniem smaku wędzenia do wódki', 'Usuwaniem zanieczyszczeń i kongenerów dla łagodności', 'Chłodzeniem wódki do temperatury -18°C', 'Dodawaniem minerałów dla lepszego smaku'],
      },
      {
        text: 'Jaka jest idealna temperatura podawania wódki?',
        answer: '-18 do -10°C (mocno schłodzona)',
        options: ['W temperaturze pokojowej 20°C', 'Dokładnie 0°C (zamarzania)', '-18 do -10°C (mocno schłodzona)', 'Podgrzana do 40°C'],
      },
      // Whisky/Whiskey
      {
        text: 'Czym różni się Scotch Whisky od Irish Whiskey?',
        answer: 'Scotch bywa torfowy, Irish jest potrójnie destylowany i łagodniejszy',
        options: ['Scotch zawsze z jednego słodu, Irish z mieszanki', 'Scotch pisze się bez "e", Irish z "e" – to jedyna różnica', 'Scotch bywa torfowy, Irish jest potrójnie destylowany i łagodniejszy', 'Irish jest dymny, Scotch słodki'],
      },
      {
        text: 'Co to jest Bourbon?',
        answer: 'Amerykańska whiskey z min. 51% kukurydzy',
        options: ['Kanadyjska whisky z żyta', 'Tennessee whiskey ze szczepu kukurydzy', 'Amerykańska whiskey z min. 51% kukurydzy', 'Japońska whisky w stylu szkockim'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Whisky z jednego browaru, ze słodowanego jęczmienia',
        options: ['Whisky z jednego szczepu winogron', 'Whisky destylowana jednorazowo', 'Whisky z jednego browaru, ze słodowanego jęczmienia', 'Whisky z jednej beczki (single cask)'],
      },
      {
        text: 'Jak długo leżakuje 12-letnia Scotch whisky?',
        answer: 'Minimum 12 lat w beczkach (wiek najmłodszego składnika)',
        options: ['Dokładnie 12 lat do dnia', 'Co najmniej 12 lat od zamknięcia butelki', 'Minimum 12 lat w beczkach (wiek najmłodszego składnika)', 'Między 10 a 12 latami'],
      },
      {
        text: 'Co to jest "Angels\' Share"?',
        answer: 'Alkohol parujący z beczki podczas leżakowania',
        options: ['Nagroda dla najlepszego destylatora', 'Alkohol parujący z beczki podczas leżakowania', 'Pierwsza porcja destylatu wylewana dla bezpieczeństwa', 'Specjalna edycja limitowana na święta'],
      },
      {
        text: 'Co to jest Japanese Whisky?',
        answer: 'Whisky z Japonii wzorowana na stylu szkockim',
        options: ['Sake przefermentowane po raz drugi', 'Japońska wódka ryżowa w stylu western', 'Whisky z Japonii wzorowana na stylu szkockim', 'Import szkockiej whisky butelkowanej w Japonii'],
      },
      // Gin
      {
        text: 'Jaki smak musi dominować w ginie?',
        answer: 'Jałowiec',
        options: ['Cytrusy', 'Kolendra', 'Jałowiec', 'Anyż'],
      },
      {
        text: 'Czym różni się London Dry Gin od New Western Gin?',
        answer: 'W London Dry dominuje jałowiec, New Western akcentuje inne botaniki',
        options: ['London Dry jest produkowany tylko w Londynie', 'New Western to gin bez jałowca', 'W London Dry dominuje jałowiec, New Western akcentuje inne botaniki', 'Różnią się wyłącznie ceną, nie składem'],
      },
      {
        text: 'Jaki tonic najlepiej pasuje do premium ginu wg barmanów?',
        answer: 'Tonik wytrawny, mało cukru, mocno gazowany',
        options: ['Tonik z dużą ilością cukru dla zbalansowania', 'Tonik o smaku cytrynowym', 'Tonik wytrawny, mało cukru, mocno gazowany', 'Zwykła woda gazowana'],
      },
      {
        text: 'Który kraj jest globalnym liderem konsumpcji ginu?',
        answer: 'Filipiny',
        options: ['Wielka Brytania', 'Hiszpania', 'Filipiny', 'USA'],
      },
      {
        text: 'Co to jest Sloe Gin?',
        answer: 'Likier na bazie ginu z owocami tarniny',
        options: ['Powolnie (slow) destylowany gin', 'Gin z dodatkiem śliwek japońskich', 'Likier na bazie ginu z owocami tarniny', 'Niskoalkoholowy gin bez destylacji'],
      },
      // Rum i tequila
      {
        text: 'Z czego produkuje się rum?',
        answer: 'Z melasy lub soku z trzciny cukrowej',
        options: ['Z ryżu i trzciny cukrowej', 'Z fermentowanych bananów tropikalnych', 'Z melasy lub soku z trzciny cukrowej', 'Z destylowanego kakao i cukru'],
      },
      {
        text: 'Czym różni się rum biały od ciemnego?',
        answer: 'Biały prawie nie leżakuje, ciemny dojrzewa latami w beczkach',
        options: ['Biały jest z trzciny, ciemny z melasy', 'Ciemny ma mniej alkoholu', 'Biały prawie nie leżakuje, ciemny dojrzewa latami w beczkach', 'Różnią się wyłącznie barwnikiem'],
      },
      {
        text: 'Z czego produkuje się tequilę?',
        answer: 'Z agawy niebieskiej (z Jalisco w Meksyku)',
        options: ['Z kaktusa saguaro', 'Z fermentowanego soku z limonki i agawy', 'Z agawy niebieskiej (z Jalisco w Meksyku)', 'Z fermentowanego kukurydzianego piwa'],
      },
      {
        text: 'Co to jest Mezcal i czym różni się od tequili?',
        answer: 'Mezcal jest z różnych agaw, często pieczonych – stąd dymny smak',
        options: ['Mezcal to tequila z robakiem w butelce', 'Tequila to rodzaj mezcalu; mezcal pochodzi z Oaxaki', 'Mezcal jest z różnych agaw, często pieczonych – stąd dymny smak', 'Mezcal i tequila to dokładnie to samo'],
      },
      {
        text: 'Co to jest robak w mezcalu?',
        answer: 'Larwa ćmy z agawy – chwyt marketingowy, nie tradycja',
        options: ['Symbol jakości chronionej CRTM', 'Larwa ćmy z agawy – chwyt marketingowy, nie tradycja', 'Specjalny rodzaj drożdży do fermentacji', 'Lokalny termin na kryształy z agawy'],
      },
      // Szampan i wina musujące
      {
        text: 'Który region Francji produkuje szampana?',
        answer: 'Champagne',
        options: ['Burgundia', 'Alzacja', 'Champagne', 'Langwedocja-Roussillon'],
      },
      {
        text: 'Ile atmosfer ciśnienia panuje w butelce szampana?',
        answer: 'Około 5–6 atmosfer',
        options: ['Około 1–2 atmosfer', 'Około 3 atmosfer', 'Około 5–6 atmosfer', 'Ponad 10 atmosfer'],
      },
      {
        text: 'Ile bąbelków zawiera butelka szampana?',
        answer: 'Około 47–250 milionów',
        options: ['Kilka tysięcy', 'Około 1 milion', 'Około 47–250 milionów', 'Ponad miliard'],
      },
      {
        text: 'Co to jest Cava?',
        answer: 'Hiszpańskie wino musujące, głównie z Katalonii',
        options: ['Włoskie wino musujące z Piemontu', 'Hiszpańskie wino musujące, głównie z Katalonii', 'Greckie wino musujące z wyspy Santorini', 'Argentyńska odmiana prosecco'],
      },
      {
        text: 'Jak należy otwierać szampana?',
        answer: 'Powoli obracając butelkę, nie korek – cicho, nie z hukiem',
        options: ['Mocnym uderzeniem dna butelki w stół', 'Powoli obracając butelkę, nie korek – cicho, nie z hukiem', 'Specjalnym nożem do sabrage', 'Zawsze w temperaturze pokojowej, nie schłodzonego'],
      },
      // Kac i metabolizm
      {
        text: 'Jaka jest naukowa przyczyna kaca?',
        answer: 'Odwodnienie, aldehyd octowy, hipoglikemia i zapalenie',
        options: ['Wyłącznie odwodnienie', 'Tylko cukier zawarty w alkoholu', 'Odwodnienie, aldehyd octowy, hipoglikemia i zapalenie', 'Zbyt szybkie picie powodujące zatrucie żołądka'],
      },
      {
        text: 'Ile czasu potrzebuje wątroba na metabolizowanie jednej jednostki alkoholu?',
        answer: 'Około 1 godziny',
        options: ['15–20 minut', 'Około 1 godziny', 'Zależy od masy ciała – ok. 30 min na 10 kg', 'Do 6 godzin przy dużych dawkach'],
      },
      {
        text: 'Który mit o kacówkach jest naukowo obalony?',
        answer: 'Kawa nie przyspiesza trzeźwienia – tylko pobudza',
        options: ['Woda nie pomaga przy kacu', 'Jedzenie tłustego przed piciem jest bezskuteczne', 'Kawa nie przyspiesza trzeźwienia – tylko pobudza', 'Wysiłek fizyczny nie pomaga spalić alkoholu'],
      },
      {
        text: 'Czym jest "hair of the dog" (klin klinem)?',
        answer: 'Picie odrobiny alkoholu po kacu – tylko opóźnia objawy',
        options: ['Dieta tłusta następnego dnia po imprezie', 'Picie odrobiny alkoholu po kacu – tylko opóźnia objawy', 'Napój izotoniczny wzbogacony elektrolitami', 'Szkocki lek na kaca z owsianką i whisky'],
      },
      {
        text: 'Co powoduje ból głowy po czerwonym winie?',
        answer: 'Histaminy, taniny i siarczyny – nie sam etanol',
        options: ['Wyłącznie siarczyny (E220) dodawane do wina', 'Sam etanol – nic specyficznego dla czerwonego', 'Histaminy, taniny i siarczyny – nie sam etanol', 'Cukier rezydualny w wytrawnych winach'],
      },
      {
        text: 'Ile litrów wody traci człowiek przez działanie moczopędne alkoholu po wypiciu 1 litra piwa?',
        answer: 'Około 800 ml',
        options: ['Dokładnie 1 litr (tyle ile wypiłeś)', 'Około 200 ml – efekt jest minimalny', 'Około 800 ml', 'Ponad 2 litry – alkohol silnie odwadnia'],
      },
      {
        text: 'Jak jedzenie przed piciem wpływa na wchłanianie alkoholu?',
        answer: 'Tłuste potrawy spowalniają wchłanianie – BAC niższy i późniejszy',
        options: ['Jedzenie całkowicie blokuje wchłanianie alkoholu', 'Jedzenie nie wpływa na BAC – tylko na samopoczucie', 'Tłuste potrawy spowalniają wchłanianie – BAC niższy i późniejszy', 'Węglowodany blokują alkohol, tłuszcze przyspieszają'],
      },
      {
        text: 'Co to jest "blackout" alkoholowy?',
        answer: 'Brak zapisywania nowych wspomnień mimo przytomności',
        options: ['Utrata przytomności spowodowana alkoholem', 'Widzenie czarnych plamek przy hipoglikemii', 'Brak zapisywania nowych wspomnień mimo przytomności', 'Nadwrażliwość na światło podczas kaca'],
      },
      // Alkohol a zdrowie i nauka
      {
        text: 'Czy istnieje bezpieczna dawka alkoholu wg WHO 2023?',
        answer: 'Nie – żadna ilość nie jest całkowicie bezpieczna',
        options: ['Tak – do 1 jednostki dziennie jest bezpieczne', 'Tak – do 14 jednostek tygodniowo', 'Nie – żadna ilość nie jest całkowicie bezpieczna', 'Tak – kieliszek wina dziennie służy sercu'],
      },
      {
        text: 'Ile kalorii dostarcza gram czystego alkoholu?',
        answer: '7 kcal na gram',
        options: ['4 kcal – tyle samo co cukier', '7 kcal na gram', '9 kcal – tyle samo co tłuszcz', '12 kcal – najbardziej kaloryczny makroskładnik'],
      },
      {
        text: 'Jak alkohol wpływa na sen?',
        answer: 'Skraca fazę REM i fragmentuje sen, pogarszając jego jakość',
        options: ['Alkohol poprawia jakość snu przez relaksację', 'Alkohol nie wpływa na strukturę snu', 'Skraca fazę REM i fragmentuje sen, pogarszając jego jakość', 'Alkohol wydłuża fazę głębokiego snu NREM'],
      },
      {
        text: 'Ile procent nowotworów na świecie jest powiązanych z alkoholem wg IARC?',
        answer: 'Około 5–6% przypadków raka',
        options: ['Poniżej 1% – wpływ jest marginalny', 'Około 5–6% przypadków raka', 'Ponad 20%', 'Tylko rak wątroby jest związany z alkoholem'],
      },
      {
        text: 'Jaki jest efekt alkoholu na układ sercowo-naczyniowy wg aktualnej nauki?',
        answer: 'Nawet umiarkowane picie podnosi ryzyko arytmii i nadciśnienia',
        options: ['Kieliszek wina dziennie wyraźnie zmniejsza ryzyko zawału', 'Piwo jest korzystne dla serca do 2 butelek', 'Nawet umiarkowane picie podnosi ryzyko arytmii i nadciśnienia', 'Alkohol jest obojętny dla serca poniżej 14 jednostek'],
      },
      {
        text: 'Co to jest FAS (Fetal Alcohol Syndrome)?',
        answer: 'Zespół alkoholowy płodu – wady spowodowane piciem w ciąży',
        options: ['Alergia na alkohol u noworodków', 'Zespół alkoholowy płodu – wady spowodowane piciem w ciąży', 'Nadwrażliwość na alkohol wynikająca z genów', 'Choroba wątroby u noworodków'],
      },
      {
        text: 'Jaki enzym metabolizuje alkohol w wątrobie w pierwszym etapie?',
        answer: 'Dehydrogenaza alkoholowa (ADH)',
        options: ['Lipaza wątrobowa', 'Cytochrom P450 (tylko w nadmiarze)', 'Dehydrogenaza alkoholowa (ADH)', 'Amylaza śluzówkowa'],
      },
      {
        text: 'Dlaczego niektóre osoby (często Azjaci) czerwienią się po alkoholu?',
        answer: 'Wariant genu ALDH2 – wolniejszy rozkład aldehydu octowego',
        options: ['Niedobór wodny w organizmie', 'Nadwrażliwość układu nerwowego na etanol', 'Wariant genu ALDH2 – wolniejszy rozkład aldehydu octowego', 'Wysoki poziom histaminy we krwi'],
      },
      ...
      },
      {
        ...
        answer: 'Martini (wstrząśnięte, nie mieszane)',
        options: ['Old Fashioned', 'Whisky z lodem', 'Martini (wstrząśnięte, nie mieszane)', 'Negroni z cytryną'],
      },
      {
        text: 'W którym roku wynaleziono szampana według popularnej legendy?',
        answer: 'Około 1693 r. (legenda o Dom Pérignonie)',
        options: ['Około 1400 r.', 'Około 1693 r. (legenda o Dom Pérignonie)', 'W 1789 r. – rok Rewolucji Francuskiej', 'W 1850 r. – opatentowanie butelki'],
      },
      {
        text: 'Co to jest "prosecco stopper" i do czego służy?',
        answer: 'Korek uszczelniający butelkę po otwarciu, zachowujący bąbelki',
        options: ['Specjalna nakrętka na butelkę wódki', 'Korek uszczelniający butelkę po otwarciu, zachowujący bąbelki', 'Filtr do czyszczenia kieliszków', 'Termin na osobę niepijącą na imprezie'],
      },
      {
        text: 'Ile jest oficjalnych koktajli IBA (International Bartenders Association)?',
        answer: '77 oficjalnych receptur',
        options: ['12 klasycznych koktajli', '40 koktajli sezonowych', '77 oficjalnych receptur', 'Ponad 200 – dodawane co roku'],
      },
      {
        text: 'Co to jest "flairowe barmaństwo" (flair bartending)?',
        answer: 'Akrobatyczne żonglowanie butelkami przy robieniu drinków',
        options: ['Mieszanie drinków w unikalnych kolorach', 'Akrobatyczne żonglowanie butelkami przy robieniu drinków', 'Podawanie alkoholu w niestandardowych naczyniach', 'Serwowanie drinków z płomykiem'],
      },
      {
        text: 'Który kraj spożywa największą ilość alkoholu na osobę rocznie wg WHO?',
        answer: 'Czechy lub Litwa',
        options: ['Rosja', 'Niemcy', 'Czechy lub Litwa', 'Irlandia'],
      },
      {
        text: 'Co to jest "mocktail"?',
        answer: 'Koktajl przygotowany całkowicie bez alkoholu',
        options: ['Koktajl z minimalną zawartością alkoholu (<0,5%)', 'Drink z alkoholem udający bezalkoholowy', 'Koktajl przygotowany całkowicie bez alkoholu', 'Koktajl z kilkoma alkoholami jednocześnie'],
      },
      {
        text: 'Jak nazywa się technika wlewania alkoholu powoli po odwróconej łyżeczce?',
        answer: 'Layering (warstwowanie) – tworzenie warstw cieczy',
        options: ['Muddling – rozcieranie składników', 'Layering (warstwowanie) – tworzenie warstw cieczy', 'Carbonation – dodawanie CO₂', 'Infusion – moczenie składników w alkoholu'],
      },
      {
        text: 'Co to jest "muddle" w recepturze koktajlu?',
        answer: 'Rozgniatanie świeżych składników tłuczkiem barowym',
        options: ['Mieszanie alkoholu łyżką barową', 'Rozgniatanie świeżych składników tłuczkiem barowym', 'Filtrowanie koktajlu przez sito', 'Zmrażanie kieliszka przed podaniem'],
      },
      // Szukaszki i reguły picia
      {
        text: 'Co to jest promil (‰) i ile to jest mg alkoholu na 100 ml krwi?',
        answer: '1‰ = 100 mg na 100 ml krwi',
        options: ['1‰ = 1 mg/100 ml krwi', '1‰ = 10 mg/100 ml krwi', '1‰ = 100 mg na 100 ml krwi', '1‰ = 1 g alkoholu na 1 litr krwi'],
      },
      {
        text: 'Ile jednostek alkoholu (UK units) zawiera butelka wina (750 ml, 12%)?',
        answer: '9 jednostek',
        options: ['3 jednostki', '6 jednostek', '9 jednostek', '12 jednostek'],
      },
      {
        text: 'Ile czasu potrzebuje osoba 70 kg na wytrzeźwienie po 3 piwach (5%)?',
        answer: 'Około 4–5 godzin',
        options: ['Około 1 godziny', 'Około 2 godzin', 'Około 4–5 godzin', 'Ponad 10 godzin'],
      },
      {
        text: 'Ile promili alkoholu może być niebezpieczne dla życia?',
        answer: 'Powyżej 3–4‰ grozi śpiączką; śmierć zwykle przy 4–5‰+',
        options: ['Już 1‰ jest niebezpieczne', '2‰ to dawka śmiertelna', 'Powyżej 3–4‰ grozi śpiączką; śmierć zwykle przy 4–5‰+', 'Alkohol nigdy nie jest śmiertelny sam w sobie'],
      },
      {
        text: 'Jak alkohol wpływa na podejmowanie decyzji seksualnych?',
        answer: 'Hamuje ocenę ryzyka, prowadząc do ryzykownych decyzji',
        options: ['Alkohol zwiększa zdolności decyzyjne przez relaks', 'Brak udokumentowanego wpływu na decyzje', 'Hamuje ocenę ryzyka, prowadząc do ryzykownych decyzji', 'Sprawia, że kobiety są bardziej asertywne seksualnie'],
      },
      // Popularne drinki imprezowe
      {
        text: 'Z czego składa się Jägerbomb?',
        answer: 'Shot Jägermeistera wrzucony do napoju energetycznego',
        options: ['Jägermeister z sokiem pomarańczowym', 'Shot Jägermeistera wrzucony do napoju energetycznego', 'Jägermeister z piwem pszenicznym', 'Dwa shoty różnych ziołówek z lodem'],
      },
      {
        text: 'Co to jest "Kamikaze" shot?',
        answer: 'Wódka, triple sec i sok z limonki',
        options: ['Tequila, sól i limonka', 'Wódka, triple sec i sok z limonki', 'Rum, sok limonkowy i tabasco', 'Gin, tonik i grenadyna w jednym shocie'],
      },
      {
        text: 'Czym jest "Sambuca"?',
        answer: 'Włoski likier anyżkowy, często palony przed wypiciem',
        options: ['Hiszpańska brandy cytrusowa', 'Włoski likier anyżkowy, często palony przed wypiciem', 'Szwedzka gorzka ziołowa nalewka', 'Grecka ouzo z dodatkiem likieru owocowego'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Meksykański drink z tequili, grejpfruta i wody gazowanej',
        options: ['Hiszpański drink z wina różowego i limonady', 'Meksykański drink z tequili, grejpfruta i wody gazowanej', 'Kubański drink z rumu, grejpfruta i mięty', 'Kolumbijski drink na bazie aguardiente i cytrusów'],
      },
      {
        text: 'Jak się nazywa drink z wódki, soku żurawinowego, limonki i ginger beer?',
        answer: 'Moscow Mule',
        options: ['Dark and Stormy', 'Moscow Mule', 'Shirley Temple', 'Greyhound'],
      },
      {
        text: 'Co to jest "Gimlet"?',
        answer: 'Gin z sokiem z limonki i syropem cukrowym',
        options: ['Whisky ze słodkim wermutem i bitterem', 'Rum, mięta i woda gazowana', 'Gin z sokiem z limonki i syropem cukrowym', 'Gin z tonikiem bzowym i ogórkiem'],
      },
      {
        text: 'Co to jest "Aperitivo hour"?',
        answer: 'Włoski drink przed kolacją, często z przekąskami',
        options: ['Poranny drink podany z kawą', 'Włoski drink przed kolacją, często z przekąskami', 'Zamknięte imprezy dla znajomych w domach', 'Nocna degustacja win w restauracji'],
      },
      // Drinki specjalne dla wieczoru panieńskiego
      {
        text: 'Jaki kolor ma grenadyna i z czego jest zrobiona?',
        answer: 'Czerwony – tradycyjnie z granatu',
        options: ['Pomarańczowy – z pomarańczy i cukru', 'Czerwony – tradycyjnie z granatu', 'Różowy – wyłącznie z malin', 'Fioletowy – z jagód i borówek'],
      },
      {
        text: 'Co to jest "Strawberry Daiquiri"?',
        answer: 'Mrożony drink z rumu, truskawek i limonki',
        options: ['Truskawkowe prosecco z grenadyną', 'Mrożony drink z rumu, truskawek i limonki', 'Drink z wódki truskawkowej i toniku', 'Likier truskawkowy z lemoniadą'],
      },
      {
        text: 'Jak się nazywa drink z wódki i soku żurawinowego?',
        answer: 'Cape Codder',
        options: ['Screwdriver', 'Cape Codder', 'Greyhound', 'Sea Breeze'],
      },
      {
        text: 'Co to jest Lychee Martini?',
        answer: 'Wódka, likier lichi i sok z lichi',
        options: ['Gin z cytrusami i słodkim wermutem', 'Wódka, likier lichi i sok z lichi', 'Szampan z musem egzotycznych owoców', 'Rum z mlekiem kokosowym i lichi'],
      },
      {
        text: 'Jaki drink podaje się w ananas wydrążony jako naczynie?',
        answer: 'Piña Colada',
        options: ['Tequila Sunrise', 'Piña Colada', 'Rum Punch', 'Blue Lagoon'],
      },
      {
        text: 'Co to jest "Blue Lagoon"?',
        answer: 'Wódka, blue curaçao i lemoniada',
        options: ['Gin z tonikiem i niebieskim syropem', 'Wódka, blue curaçao i lemoniada', 'Rum z sokiem ananasowym i barwnikiem', 'Szampan z syropem borówkowym'],
      },
      // Historia i ciekawostki
      {
        text: 'Kiedy w USA zakończono prohibicję?',
        answer: '1933 r.',
        options: ['1920 r.', '1929 r. – po krachu giełdowym', '1933 r.', '1945 r. – po II wojnie światowej'],
      },
      {
        text: 'Który kraj jako pierwszy na świecie zalegalizował sprzedaż alkoholu po weekendach?',
        answer: 'Finlandia',
        options: ['Szwecja', 'Finlandia', 'Norwegia', 'Polska'],
      },
      {
        text: 'Co to jest "Bacchanalian" i skąd pochodzi to słowo?',
        answer: 'Hulanka z winem wywodząca się z kultu Bachusa',
        options: ['Starożytna egipska recepta na piwo', 'Hulanka z winem wywodząca się z kultu Bachusa', 'Religijny zakaz spożycia alkoholu', 'Włoska impreza plenerowa z winem'],
      },
      {
        text: 'Które piwo jest uważane za najstarszy udokumentowany przepis na alkohol?',
        answer: 'Sumeryjski "Hymn do Ninkasi" (ok. 1800 p.n.e.)',
        options: ['Egipskie piwo z papirusu Ebera (ok. 1500 p.n.e.)', 'Sumeryjski "Hymn do Ninkasi" (ok. 1800 p.n.e.)', 'Chińskie wino ryżowe z Jiahu (ok. 7000 p.n.e.)', 'Mezopotamskie wino winogronowe (ok. 4000 p.n.e.)'],
      },
      {
        text: 'Co to jest Absynt i dlaczego był zakazany?',
        answer: 'Likier z piołunem, zakazany przez mit o halucynogenności',
        options: ['Chemiczny alkohol przemysłowy używany w latach 20.', 'Likier z piołunem, zakazany przez mit o halucynogenności', 'Trunek z ekstraktem opium, zakazany przez ONZ', 'Wzmocnione wino z kokainą jak "Vin Mariani"'],
      },
      {
        text: 'Jaka jest zawartość alkoholu w polskiej Spirytusie Rektyfikowanym?',
        answer: '95–96%',
        options: ['75%', '80%', '95–96%', '99,9% – czysty etanol'],
      },
      {
        text: 'Co to jest "sipping whisky"?',
        answer: 'Whisky do powolnego delektowania się w czystej postaci',
        options: ['Whisky o mocy powyżej 60%', 'Specjalny szczep słodowanego ziarna', 'Whisky do powolnego delektowania się w czystej postaci', 'Whisky podawana przez słomkę bambusową'],
      },
      {
        text: 'Jaka jest różnica między brandy a koniakiem?',
        answer: 'Koniak to brandy z regionu Cognac we Francji',
        options: ['Brandy jest z winogron, koniak z jabłek', 'Koniak leżakuje w dębie, brandy w stali', 'Koniak to brandy z regionu Cognac we Francji', 'Brandy i koniak to to samo – różnią się ceną'],
      },
      {
        text: 'Co to jest Armagnac?',
        answer: 'Francuska brandy z regionu Gaskonia',
        options: ['Belgijska czekoladowa nalewka', 'Włoska brandy z Piemontu', 'Francuska brandy z regionu Gaskonia', 'Hiszpańska brandy z winnic przy Kordobie'],
      },
      {
        text: 'Czym jest Calvados?',
        answer: 'Normandzka brandy jabłkowa (lub gruszkowa)',
        options: ['Belgijski likier śliwkowy', 'Normandzka brandy jabłkowa (lub gruszkowa)', 'Bretoński niedestylowany cydr', 'Alzacki owocowy schnapps'],
      },
      {
        text: 'Co to jest Grappa?',
        answer: 'Włoski destylat z wytłoków winogronowych',
        options: ['Włoski likier cytrusowy z Sycylii', 'Włoski destylat z wytłoków winogronowych', 'Piemoncki likier z orzechów laskowych', 'Dolnowłoska wódka ryżowa'],
      },
      {
        text: 'Co to jest Ouzo?',
        answer: 'Grecki likier anyżkowy mętniejący po dodaniu wody',
        options: ['Turecka rakı z figami', 'Grecki likier anyżkowy mętniejący po dodaniu wody', 'Albański destylat winogronowy', 'Cypryjska nalewka z kopru włoskiego'],
      },
      {
        text: 'Jaka jest różnica między Pastis a Pernod?',
        answer: 'Pastis to gatunek anyżowego aperitifu, Pernod to marka',
        options: ['Pernod to marka absyntu, pastis jest bez thujonu', 'Pastis jest słodszy, Pernod wytrawny', 'Pastis to gatunek anyżowego aperitifu, Pernod to marka', 'Są identyczne – różnią się tylko opakowaniem'],
      },
      // Barman i techniki
      {
        text: 'Co to jest "free pouring" u barmana?',
        answer: 'Nalewanie alkoholu bez miarki, z pamięci',
        options: ['Podawanie drinków gratis w happy hour', 'Nalewanie alkoholu bez miarki, z pamięci', 'Technika nalewania piwa bez pianki', 'Serwowanie alkoholu prosto z beczki'],
      },
      {
        text: 'Co to jest "jigger" w barmańskim slangu?',
        answer: 'Mała dwustronna miarka do alkoholu',
        options: ['Rodzaj shakera', 'Małe naczynie do degustacji', 'Mała dwustronna miarka do alkoholu', 'Nakrętka do butelek alkoholu'],
      },
      {
        text: 'Jaka jest różnica między "up" a "on the rocks" przy zamawianiu drinka?',
        answer: '"Up" – bez lodu w kieliszku; "on the rocks" – z lodem',
        options: ['"Up" to drink podany do góry nogami', '"On the rocks" to drink z solą na krawędzi', '"Up" – bez lodu w kieliszku; "on the rocks" – z lodem', '"Up" to wyższy kieliszek, "rocks" to niższy'],
      },
      {
        text: 'Co to jest "dirty" w kontekście Martini?',
        answer: 'Martini z dodatkiem solanki z oliwek',
        options: ['Martini bez lodu i bez wermutu', 'Martini z nierówno zmielonymi ziołami', 'Martini z dodatkiem solanki z oliwek', 'Martini wstrząśnięte zamiast mieszane'],
      },
      {
        text: 'Jak schładza się kieliszek do martini przed podaniem?',
        answer: 'Wypełniając lodem i wodą na kilka minut',
        options: ['Wkładając do zamrażarki na co najmniej 24 godziny', 'Wypełniając lodem i wodą na kilka minut', 'Polewając kieliszek zimną wodą pod kranem', 'Schładzanie nie jest potrzebne przy zimnym drinku'],
      },
      {
        text: 'Co to jest "amaro"?',
        answer: 'Włoski gorzki likier ziołowy',
        options: ['Słodki włoski deser z mascarpone', 'Włoski gorzki likier ziołowy', 'Argentyński napój fermentowany z ziół', 'Katalońska gorzka nalewka bez alkoholu'],
      },
      {
        text: 'Co to jest Fernet-Branca?',
        answer: 'Włoski amaro z 27 ziołami',
        options: ['Szwajcarska wódka ziołowa z alpejskich kwiatów', 'Włoski amaro z 27 ziołami', 'Czeski bitter ze szkoły mniszej', 'Belgijski likier czekoladowo-ziołowy'],
      },
      {
        text: 'Co to jest "Angostura Bitters"?',
        answer: 'Esencja bitterów dodawana kroplami do koktajli',
        options: ['Wenezuelski rum z wyspy Trinidad', 'Esencja bitterów dodawana kroplami do koktajli', 'Argentyński aperitif o smaku anyżowym', 'Bitter produkowany wyłącznie do celów medycznych'],
      },
      // Wino musujące i szampan – szczegóły
      {
        text: 'Co to jest "Riddling" w produkcji szampana?',
        answer: 'Stopniowe obracanie butelek, by zsunąć osad do szyjki',
        options: ['Dodawanie drożdży do butelki przed fermentacją', 'Stopniowe obracanie butelek, by zsunąć osad do szyjki', 'Degustacja szampana po 3 latach leżakowania', 'Etykietowanie butelek szampana'],
      },
      {
        text: 'Co to jest "dégorgement"?',
        answer: 'Usuwanie osadu z szyjki przez jej zamrożenie',
        options: ['Dodawanie mieszanki dosage po otwarciu', 'Usuwanie osadu z szyjki przez jej zamrożenie', 'Degustacja wina po riddlingu przez sommeliera', 'Korekta kwasowości przed finałowym korkowaniem'],
      },
      {
        text: 'Co to jest "dosage" w szampanie?',
        answer: 'Mieszanka cukru i wina ustalająca słodkość szampana',
        options: ['Ilość CO₂ dodawana do butelki', 'Mieszanka cukru i wina ustalająca słodkość szampana', 'Zawartość alkoholu mierzona przed butelkowaniem', 'Dawka siarki jako konserwant'],
      },
      {
        text: 'Co oznacza "NV" (Non-Vintage) na butelce szampana?',
        answer: 'Blend roczników bez podanego roku, dla stałego stylu',
        options: ['Niskoalkoholowe wino musujące', 'Blend roczników bez podanego roku, dla stałego stylu', 'Nowy wariant smaku marki', 'Skrót od "Nowa Vintage" – najnowszy rocznik'],
      },
      // Popularne pytania wiedzy ogólnej
      {
        text: 'Jaki drink jest tradycyjnie podawany na Nowy Rok w Polsce?',
        answer: 'Szampan lub wino musujące',
        options: ['Wódka z ogórkiem kiszonym', 'Miód pitny', 'Szampan lub wino musujące', 'Krupnik – miodówka z korzeniami'],
      },
      {
        text: 'Czym jest Krupnik?',
        answer: 'Polski likier na miodzie i korzeniach, podawany gorący',
        options: ['Zupa z kaszy w wydaniu alkoholowym', 'Polski likier na miodzie i korzeniach, podawany gorący', 'Litewskie piwo miodowe', 'Rosyjska wódka z miodowym aromatem'],
      },
      {
        text: 'Co to jest Nalewka?',
        answer: 'Maceraty owocowe lub ziołowe na spirytusie',
        options: ['Rodzaj polskiej wódki klasy premium', 'Maceraty owocowe lub ziołowe na spirytusie', 'Mieszanina win importowanych pod polską etykietą', 'Zakwas na chleb – nie alkohol'],
      },
      {
        text: 'Czym jest Miód pitny?',
        answer: 'Fermentowany napój miodowy, jeden z najstarszych alkoholi',
        options: ['Miód z wodą podgrzany do gorącej czekolady', 'Fermentowany napój miodowy, jeden z najstarszych alkoholi', 'Likier miodowy na bazie spirytusu', 'Napój bezalkoholowy z miodu i jabłek'],
      },
      {
        text: 'Co to jest Goldwasser (Goldwasser Gdańsk)?',
        answer: 'Gdański likier ziołowy z płatkami złota',
        options: ['Polska wódka z Mazur o smaku zboża', 'Gdański likier ziołowy z płatkami złota', 'Woda mineralna z Gdańska z alkoholem', 'Pruski koniak produkowany do 1945 r.'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Meksykański likier kawowy na bazie rumu',
        options: ['Whisky, kawa i syrop klonowy', 'Meksykański likier kawowy na bazie rumu', 'Wódka z ekstraktem kawowca i mlekiem', 'Brazylijska cachaça z kawą i czekoladą'],
      },
      {
        text: 'Co to jest Amaretto?',
        answer: 'Włoski słodki likier migdałowy',
        options: ['Gorzki włoski aperitif na ziołach alpejskich', 'Włoski słodki likier migdałowy', 'Destylat wiśniowy z Piemontu', 'Nalewka z migdałów i grappy'],
      },
      {
        text: 'Jak się nazywa drink z Amaretto i soku pomarańczowego?',
        answer: 'Amaretto Sour (z cytryną) lub Godfather (z whisky)',
        options: ['Sicilian Sunrise', 'Italian Dream', 'Amaretto Sour (z cytryną) lub Godfather (z whisky)', 'Venetian Kiss'],
      },
      {
        text: 'Co to jest Limoncello?',
        answer: 'Włoski likier z macerowanych skórek cytryn',
        options: ['Sycylijska lemoniada z domieszką alkoholu', 'Włoski likier z macerowanych skórek cytryn', 'Neapolitańskie wino cytrynowe', 'Likier robiony tylko przez zakonnice w Kampanii'],
      },
      {
        text: 'Co to jest Chambord?',
        answer: 'Francuski likier z czarnych malin i owoców leśnych',
        options: ['Francuski koniak z regionu Chambord', 'Francuski likier z czarnych malin i owoców leśnych', 'Alzacka nalewka z borówek', 'Likier produkowany w Château Chambord'],
      },
      {
        text: 'Jak się nazywa tradycyjny japoński alkohol ryżowy?',
        answer: 'Sake',
        options: ['Soju', 'Umeshu', 'Sake', 'Shochu'],
      },
      {
        text: 'Czym różni się Sake od Shochu?',
        answer: 'Sake jest fermentowane (~15%), Shochu destylowane (do 45%)',
        options: ['Sake jest mocniejsze (40%), Shochu słabsze (5%)', 'Sake to napój z ryżu brązowego, Shochu z białego', 'Sake jest fermentowane (~15%), Shochu destylowane (do 45%)', 'Shochu pochodzi z Chin, Sake tylko z Japonii'],
      },
      {
        text: 'Co to jest Soju?',
        answer: 'Koreański destylowany alkohol podobny do wódki',
        options: ['Japońskie sake z dodatkiem limonki', 'Chiński baijiu rozcieńczony do koreańskich norm', 'Koreański destylowany alkohol podobny do wódki', 'Koreańskie piwo ryżowe z gazowaniem'],
      },
      {
        text: 'Jaki jest najdrożej sprzedany alkohol na świecie?',
        answer: 'Macallan 1926 – ok. 2,7 mln USD',
        options: ['Pétrus 1945 – ok. 1 mln USD', 'Macallan 1926 – ok. 2,7 mln USD', 'Dom Pérignon Rosé – 500 000 USD', 'Kolekcjonerska Coca-Cola – 3 mln USD'],
      },
      {
        text: 'Ile procent pary wodnej wydziela się podczas destylacji jako "heads" (głowa) do odrzucenia?',
        answer: 'Pierwsze 5–10% destylatu z metanolem – odrzucane',
        options: ['Głowy stanowią ponad 50% destylatu', 'Głowy są zachowywane jako najlepszy alkohol', 'Pierwsze 5–10% destylatu z metanolem – odrzucane', 'Metanol usuwa się przez filtrację, nie odrzucenie'],
      },
      {
        text: 'Co to jest "Tails" w destylacji?',
        answer: 'Końcowa frakcja destylatu z fuzlami – odrzucana',
        options: ['Etykieta na butelce destylatu', 'Końcowa frakcja destylatu z fuzlami – odrzucana', 'Ostatnie kilka butelek z partii', 'Specjalna wersja alkoholu leżakowana najdłużej'],
      },
      {
        text: 'Które piwo ma najwyższy poziom alkoholu na świecie?',
        answer: 'Snake Venom – ok. 67,5% ABV',
        options: ['Carlsberg Special – 20%', 'Sam Adams Utopias – 28%', 'Snake Venom – ok. 67,5% ABV', 'Chimay Grande Reserve – 9%'],
      },
      {
        text: 'Czym jest "barrel aging" koktajli?',
        answer: 'Leżakowanie gotowych koktajli w małych beczkach dębowych',
        options: ['Leżakowanie kieliszków w piwnicy przed podaniem', 'Leżakowanie gotowych koktajli w małych beczkach dębowych', 'Dodawanie wiórków dębowych do shakera', 'Podawanie drinków w drewnianych kubkach'],
      },
      {
        text: 'Co to jest "bottle service" w klubie?',
        answer: 'Zakup całej butelki z rezerwacją stolika VIP',
        options: ['Darmowa butelka wody przy zamówieniu drinków', 'Zakup całej butelki z rezerwacją stolika VIP', 'Specjalny serwis dostawy alkoholu do domu', 'Voucher na darmowy drink w urodziny'],
      },
      {
        text: 'Ile promili to granica stanu wskazania (nie upojenia) w Polsce?',
        answer: '0,2–0,5‰ to stan po spożyciu, powyżej 0,5‰ – upojenie',
        options: ['Każde stężenie powyżej 0,1‰', '0,2–0,5‰ to stan po spożyciu, powyżej 0,5‰ – upojenie', '1,0‰ i powyżej to granica wskazania', 'W Polsce nie ma definicji stanu wskazania'],
      },
      {
        text: 'Jak długo pozostaje alkohol wykrywalny w moczu?',
        answer: 'Etanol do ~12 h, metabolit EtG nawet do 80 h',
        options: ['Maksymalnie 2 godziny', 'Dokładnie 24 godziny', 'Etanol do ~12 h, metabolit EtG nawet do 80 h', 'Alkohol jest widoczny w moczu przez cały tydzień'],
      },
      // Finałowe uzupełnienie – 24 pytania
      {
        text: 'Co to jest "shrub" w nowoczesnym barmaństwie?',
        answer: 'Owocowo-octowy syrop dodający koktajlom kwasowości',
        options: ['Rodzaj garniru z ziół na krawędzi szklanki', 'Owocowo-octowy syrop dodający koktajlom kwasowości', 'Napar z owoców bez alkoholu', 'Technika zamrażania cytrusów do koktajli'],
      },
      {
        text: 'Jaki drink tradycyjnie pija się na wieczorze panieńskim w UK?',
        answer: 'Prosecco, Jägerbomby i "Woo Woo"',
        options: ['Piwo Guinness', 'Prosecco, Jägerbomby i "Woo Woo"', 'Port z tonikiem', 'Wyłącznie szampan Premier Cru'],
      },
      {
        text: 'Co to jest "Sgroppino"?',
        answer: 'Wenecki drink: sorbet cytrynowy, prosecco i wódka',
        options: ['Sycylijska granita z limoncello', 'Wenecki drink: sorbet cytrynowy, prosecco i wódka', 'Piemoncki koktajl z Arneis i grejpfrutem', 'Toskański drink ze Vin Santo i lodu'],
      },
      {
        text: 'Czym jest "aquavit" (akvavit)?',
        answer: 'Skandynawski destylat aromatyzowany kminem lub koprem',
        options: ['Fińska wódka arktyczna', 'Skandynawski destylat aromatyzowany kminem lub koprem', 'Islandzki likier z porostów', 'Duński ekstrakt z ryb morskich'],
      },
      {
        text: 'Jaka jest polska norma zawartości alkoholu w wódce?',
        answer: 'Minimum 37,5% ABV',
        options: ['Dokładnie 40% – mniej to nie wódka', 'Minimum 37,5% ABV', 'Co najmniej 50% ABV', 'Brak minimalnej normy w UE'],
      },
      {
        text: 'Co to jest Baijiu?',
        answer: 'Chiński destylat ze zboża, ok. 50–60% ABV',
        options: ['Japońska wódka ryżowa dla kobiet', 'Chiński destylat ze zboża, ok. 50–60% ABV', 'Koreańskie piwo ryżowe z fusami', 'Wietnamski likier z ryżu i ziół'],
      },
      {
        text: 'Co to jest Pisco?',
        answer: 'Peruwiański/chilijski destylat winogronowy',
        options: ['Meksykański rum z Jukatanu', 'Peruwiański/chilijski destylat winogronowy', 'Kolumbijska cachaça z Karaibów', 'Argentyński likier różany'],
      },
      {
        text: 'Z czego składa się Pisco Sour?',
        answer: 'Pisco, limonka, syrop, białko jajka i bitter',
        options: ['Cachaça, limonka, cukier, soda', 'Pisco, limonka, syrop, białko jajka i bitter', 'Tequila, grejpfrut, sól, białko', 'Rum, cytryna, syrop, piana z mleka'],
      },
      {
        text: 'Jak się nazywa cydr musujący z Normandii?',
        answer: 'Cidre Bouché Brut de Normandie',
        options: ['Calvados Extra Young', 'Cidre Bouché Brut de Normandie', 'Pommeau de Normandie', 'Poiré – gruszkowiec z Normandii'],
      },
      {
        text: 'Co to jest Poiré?',
        answer: 'Cydr gruszkowy z Normandii lub Bretanii',
        options: ['Belgijskie piwo pszeniczne z gruszką', 'Cydr gruszkowy z Normandii lub Bretanii', 'Alzacki destylat gruszkowy (eau-de-vie)', 'Szwajcarski likier gruszkowy z kawą'],
      },
      {
        text: 'Ile procent alkoholu ma Campari?',
        answer: '20,5–25%',
        options: ['5%', '12%', '20,5–25%', '40%'],
      },
      {
        text: 'Czym zabarwiony był oryginalny Campari?',
        answer: 'Koszenilą (barwnikiem z owadów)',
        options: ['Sokiem z wiśni i buraków', 'Czerwoną papryką i kurkumą', 'Koszenilą (barwnikiem z owadów)', 'Ekstraktem z różowego pieprzu'],
      },
      {
        text: 'Co to jest "Punt e Mes"?',
        answer: 'Włoski czerwony wermut o intensywnej goryczy',
        options: ['Piemoncki destylat ze skórek cytrusów', 'Włoski czerwony wermut o intensywnej goryczy', 'Toskański likier szałwiowy', 'Sycylijski amaretto z migdałów i wina'],
      },
      {
        text: 'Jaki drink podaje się w miedzianym kubku i dlaczego?',
        answer: 'Moscow Mule – miedź schładza go szybciej',
        options: ['Negroni – dla zachowania temperatury', 'Mojito – miedź redukuje utlenianie mięty', 'Moscow Mule – miedź schładza go szybciej', 'Dark and Stormy – tradycja z XVIII-wiecznych statków'],
      },
      {
        text: 'Co to jest Tequila Blanco (Silver)?',
        answer: 'Tequila bez leżakowania lub do 60 dni',
        options: ['Tequila z dodatkiem srebra koloidalnego', 'Tequila z mniej niż 51% agawy niebieskiej', 'Tequila bez leżakowania lub do 60 dni', 'Najdroższa klasa tequili'],
      },
      {
        text: 'Co to jest Tequila Añejo?',
        answer: 'Tequila leżakująca 1–3 lata w beczkach dębowych',
        options: ['Tequila produkowana przed 1950 r.', 'Tequila z dodatkiem karmelu jako barwnika', 'Tequila leżakująca 1–3 lata w beczkach dębowych', 'Tequila przefiltrowana przez węgiel aktywny'],
      },
      {
        text: 'Ile kalorii ma standardowy kieliszek (40 ml) wódki 40%?',
        answer: 'Około 96 kcal',
        options: ['Około 20 kcal', 'Około 50 kcal', 'Około 96 kcal', 'Około 200 kcal'],
      },
      {
        text: 'Czym jest "ABV" na etykiecie alkoholu?',
        answer: 'Alcohol By Volume – procent etanolu w napoju',
        options: ['Absolute Best Vintage – oznaczenie jakości', 'Alcohol By Volume – procent etanolu w napoju', 'Average Bottle Value – cena rynkowa butelki', 'Ageing Barrel Variety – typ beczki'],
      },
      {
        text: 'Co to jest "Proof" jako miara alkoholu (system USA)?',
        answer: 'Proof w USA = 2 × ABV%, więc 80 proof = 40%',
        options: ['Proof = ABV% / 2', 'Proof w USA = 2 × ABV%, więc 80 proof = 40%', 'Proof = 10 × zawartość w g/l', 'Proof to certyfikat jakości bez związku z alkoholem'],
      },
      {
        text: 'Jaki jest najpopularniejszy alkohol spożywany na polskich weselach?',
        answer: 'Wódka',
        options: ['Piwo', 'Wino', 'Wódka', 'Nalewki domowe'],
      },
      {
        text: 'Jak alkohol wpływa na koordynację ruchową?',
        answer: 'Hamuje móżdżek i układ przedsionkowy – stąd zataczanie',
        options: ['Poprawia koordynację przez relaks mięśni', 'Wpływa tylko na wzrok, nie na ruch', 'Hamuje móżdżek i układ przedsionkowy – stąd zataczanie', 'Koordynacja spada dopiero po 3‰'],
      },
      {
        text: 'Co to jest "drink spiking" i dlaczego jest przestępstwem?',
        answer: 'Dodawanie alkoholu lub środków odurzających bez wiedzy osoby',
        options: ['Wlewanie mocniejszego alkoholu do słabszego drinka', 'Dodawanie alkoholu lub środków odurzających bez wiedzy osoby', 'Serwowanie alkoholu nieletnim w koktajlach', 'Podawanie fałszywego mocnego alkoholu jako wody'],
      },
      {
        text: 'Jaki smak ma Galliano?',
        answer: 'Anyżowo-waniliowy z nutami cytrusów i ziół',
        options: ['Kawowy z kardamonem i wanilią', 'Anyżowo-waniliowy z nutami cytrusów i ziół', 'Czekoladowo-miętowy', 'Malinowo-różany z pieprzem'],
      },
      {
        text: 'Co to jest "toast" i skąd pochodzi tradycja wznoszenia toastów?',
        answer: 'Z dawnego zwyczaju wkładania opieczonego chleba (toast) do wina',
        options: ['Z angielskiego słowa "toast" oznaczającego ogień', 'Z dawnego zwyczaju wkładania opieczonego chleba (toast) do wina', 'Z francuskiej tradycji monarchistycznej z XIV w.', 'Z greckiego słowa "toastos" oznaczającego zdrowie'],
      },
    ],
  },
]
