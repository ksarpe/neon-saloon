...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const team1 = { teamId: `team_${Date.now()}_1`, teamName: team1Name.trim(), color: "#FF10F0", emoji: "🤠" };
    const team2 = { teamId: `team_${Date.now()}_2`, teamName: team2Name.trim(), color: "#FFD700", emoji: "🎯" };
